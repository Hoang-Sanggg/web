...
!function (e, t) {
    ...
    function k(e) {
        var t = !!e && "length" in e && e.length
            , n = b(e);
        return !p(e) && !v(e) && ("array" === n || 0 === t || "number" == typeof t && 0 < t && t - 1 in e)
    }
    w.fn = w.prototype = {
        jquery: x,
        constructor: w,
        ...
        w.extend = w.fn.extend = function () {
            ...
            for ("boolean" == typeof a && (c = a,
                ...
                if (null != (e = arguments[s]))
                    for (t in e)
                        i = e[t],
                            "__proto__" !== t && a !== i && (c && i && (w.isPlainObject(i) || (o = Array.isArray(i))) ? (n = a[t],
                                r = o && !Array.isArray(n) ? [] : o || w.isPlainObject(n) ? n : {},
                                o = !1,
                                a[t] = w.extend(c, r, i)) : void 0 !== i && (a[t] = i));
            return a
        }
        ,
        w.extend({
            ...
            makeArray: function (e, t) {
                var n = t || [];
                return null != e && (k(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : a.call(n, e)),
                    n
            },
    ...
    var C = function (e) {
        var t, n, i, o, r, a, s, l, c, u, h, d, f, p, v, g, m, y, b, x = "sizzle" + 1 * new Date, w = e.document, k = 0, C = 0, T = le(), S = le(), E = le(), $ = le(), A = function (e, t) {
            return e === t && (h = !0),
                0
        }, L = {}.hasOwnProperty, P = [], _ = P.pop, O = P.push, N = P.push, D = P.slice, M = function (e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, j = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", I = "[\\x20\\t\\r\\n\\f]", z = "(?:\\\\[\\da-fA-F]{1,6}" + I + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", R = "\\[" + I + "*(" + z + ")(?:" + I + "*([*^$|!~]?=)" + I + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + z + "))|)" + I + "*\\]", F = ":(" + z + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)", H = new RegExp(I + "+", "g"), q = new RegExp("^" + I + "+|((?:^|[^\\\\])(?:\\\\.)*)" + I + "+$", "g"), W = new RegExp("^" + I + "*," + I + "*"), B = new RegExp("^" + I + "*([>+~]|" + I + ")" + I + "*"), X = new RegExp(I + "|>"), U = new RegExp(F), Y = new RegExp("^" + z + "$"), V = {
            ID: new RegExp("^#(" + z + ")"),
            CLASS: new RegExp("^\\.(" + z + ")"),
            TAG: new RegExp("^(" + z + "|[*])"),
            ATTR: new RegExp("^" + R),
        ...
        }, Z = /HTML$/i, G = /^(?:input|select|textarea|button)$/i, K = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Q = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + I + "?|\\\\([^\\r\\n\\f])", "g"), ne = function (e, t) {
        ...
        function se(e, t, i, o) {
            var r, s, c, u, h, p, m, y = t && t.ownerDocument, w = t ? t.nodeType : 9;
            if (i = i || [],
            ...
            if (!o && (d(t),
                ...
                if (n.qsa && !$[e + " "] && (!g || !g.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                    if (m = e,
                        ...
                        for ((y = ee.test(e) && me(t.parentNode) || t) === t && n.scope || ((u = t.getAttribute("id")) ? u = u.replace(ie, oe) : t.setAttribute("id", u = x)),
                            s = (p = a(e)).length; s--;)
                            p[s] = (u ? "#" + u : ":scope") + " " + be(p[s]);
                        m = p.join(",")
                    }
                    try {
                        return N.apply(i, y.querySelectorAll(m)),
                            i
                    } catch (t) {
                        $(e, !0)
                    } finally {
        ...
        for (t in n = se.support = {},
            ...
            d = se.setDocument = function (e) {
                ...
                return a != f && 9 === a.nodeType && a.documentElement && (p = (f = a).documentElement,
                    ...
                    A = t ? function (e, t) {
                        ...
                        return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e == f || e.ownerDocument == w && b(w, e) ? -1 : t == f || t.ownerDocument == w && b(w, t) ? 1 : u ? M(u, e) - M(u, t) : 0 : 4 & i ? -1 : 1)
                    }
                        : function (e, t) {
                            if (e === t)
                                return h = !0,
            ...
            se.matchesSelector = function (e, t) {
                if (d(e),
                    n.matchesSelector && v && !$[t + " "] && (!m || !m.test(t)) && (!g || !g.test(t)))
                    try {
                        var i = y.call(e, t);
                ...
                filter: {
                    ...
                    CHILD: function (e, t, n, i, o) {
                        ...
                        return 1 === i && 0 === o ? function (e) {
                            ...
                            : function (t, n, l) {
                                var c, u, h, d, f, p, v = r !== a ? "nextSibling" : "previousSibling", g = t.parentNode, m = s && t.nodeName.toLowerCase(), y = !l && !s, b = !1;
                                if (g) {
                                    if (r) {
                                        for (; v;) {
                                            for (d = t; d = d[v];)
                                    ...
                                    if (p = [a ? g.firstChild : g.lastChild],
                                        a && y) {
                                        for (b = (f = (c = (u = (h = (d = g)[x] || (d[x] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] || [])[0] === k && c[1]) && c[2],
                                            d = f && g.childNodes[f]; d = ++f && d && d[v] || (b = f = 0) || p.pop();)
                                            if (1 === d.nodeType && ++b && d === t) {
                                                u[e] = [k, f, b];
                                                break
                                            }
                                    } else if (y && (b = f = (c = (u = (h = (d = t)[x] || (d[x] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] || [])[0] === k && c[1]),
                                        !1 === b)
                                        for (; (d = ++f && d && d[v] || (b = f = 0) || p.pop()) && ((s ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++b || (y && ((u = (h = d[x] || (d[x] = {}))[d.uniqueID] || (h[d.uniqueID] = {}))[e] = [k, b]),
                                            d !== t));)
                                            ;
            ...
            return t.first ? function (t, n, o) {
                ...
                : function (t, n, l) {
                    ...
                    if (l) {
                        ...
                        for (; t = t[i];)
                            if (1 === t.nodeType || a)
                                if (u = (h = t[x] || (t[x] = {}))[t.uniqueID] || (h[t.uniqueID] = {}),
        ...
        function Ce(e, t, n, i, o, r) {
            return i && !i[x] && (i = Ce(i)),
                o && !o[x] && (o = Ce(o, r)),
                ce((function (r, a, s, l) {
                    var c, u, h, d = [], f = [], p = a.length, v = r || function (e, t, n) {
                        for (var i = 0, o = t.length; i < o; i++)
                            se(e, t[i], n);
                        return n
                    }(t || "*", s.nodeType ? [s] : s, []), g = !e || !r && t ? v : ke(v, d, e, s, l), m = n ? o || (r ? e : p || i) ? [] : a : g;
                    if (n && n(g, m, s, l),
                        i)
                        for (c = ke(m, f),
                            i(c, [], s, l),
                    ...
                    if (r) {
                        if (o || e) {
                            ...
                            for (u = m.length; u--;)
                                (h = m[u]) && -1 < (c = o ? M(r, h) : d[u]) && (r[c] = !(a[c] = h))
                        }
                    } else
                        m = ke(m === a ? m.splice(p, m.length) : m),
                            o ? o(null, a, m, l) : N.apply(a, m)
                }
                ))
        }
        function Te(e) {
            for (var t, n, o, r = e.length, a = i.relative[e[0].type], s = a || i.relative[" "], l = a ? 1 : 0, u = xe((function (e) {
                ...
                var o = !a && (i || n !== c) || ((t = n).nodeType ? u(e, n, i) : h(e, n, i));
                return t = null,
                    o
            }
            ]; l < r; l++)
        ...
        return ye.prototype = i.filters = i.pseudos,
            ...
            s = se.compile = function (e, t) {
                var n, o, r, s, l, u, h = [], p = [], g = E[e + " "];
                if (!g) {
                    for (t || (t = a(e)),
                        n = t.length; n--;)
                        (g = Te(t[n]))[x] ? h.push(g) : p.push(g);
                    (g = E(e, (o = p,
                        s = 0 < (r = h).length,
                        l = 0 < o.length,
                        u = function (e, t, n, a, u) {
                            var h, p, g, m = 0, y = "0", b = e && [], x = [], w = c, C = e || l && i.find.TAG("*", u), T = k += null == w ? 1 : Math.random() || .1, S = C.length;
                            for (u && (c = t == f || t || u); y !== S && null != (h = C[y]); y++) {
                                if (l && h) {
                                    for (p = 0,
                                        t || h.ownerDocument == f || (d(h),
                                            n = !v); g = o[p++];)
                                        if (g(h, t || f, n)) {
                                            a.push(h);
                                            break
                            ...
                            if (m += y,
                                ...
                                if (e) {
                                    if (0 < m)
                                        for (; y--;)
                                            b[y] || x[y] || (x[y] = _.call(a));
                                    x = ke(x)
                                }
                                N.apply(a, x),
                                    u && !e && 0 < x.length && 1 < m + r.length && se.uniqueSort(a)
                            }
                            return u && (k = T,
                                c = w),
                                b
            ...
            l = se.select = function (e, t, n, o) {
                var r, l, c, u, h, d = "function" == typeof e && e, f = !o && a(e = d.selector || e);
                if (n = n || [],
                    1 === f.length) {
                ...
                return (d || s(e, f))(o, t, !v, n, !t || ee.test(e) && me(t.parentNode) || t),
                    n
            }
            ,
    ...
    (w.fn.init = function (e, t, n) {
        ...
        if (n = n || P,
            "string" == typeof e) {
            if (!(i = "<" === e[0] && ">" === e[e.length - 1] && 3 <= e.length ? [null, e, null] : _.exec(e)) || !i[1] && t)
            ...
            return (o = g.getElementById(i[2])) && (this[0] = o,
                this.length = 1),
                this
        }
    ...
    w.Callbacks = function (e) {
                ...
                return s && (o && !i && (c = s.length - 1,
                    ...
                    function t(n) {
                        w.each(n, (function (n, i) {
                            p(i) ? e.unique && h.has(i) || s.push(i) : i && i.length && "string" !== b(i) && t(i)
                        }
                        ))
                    }(arguments),
                    o && !i && u()),
        ...
        w.extend({
                    ...
                    , o = {
                        ...
                        then: function (t, i, o) {
                                        ...
                                        , c = function () {
                                            ...
                                            if (!(t < r)) {
                                                ...
                                                c = e && ("object" == typeof e || "function" == typeof e) && e.then,
                                                    p(c) ? o ? c.call(e, a(r, n, j, o), a(r, n, I, o)) : (r++,
                                                        c.call(e, a(r, n, j, o), a(r, n, I, o), a(r, n, j, n.notifyWith))) : (i !== j && (s = void 0,
                                                            l = [e]),
                                                            (o || n.resolveWith)(s, l))
                                            }
                                        }
                            ...
                            return w.Deferred((function (e) {
                                n[0][3].add(a(0, e, p(o) ? o : j, e.notifyWith)),
                                    n[1][3].add(a(0, e, p(t) ? t : j)),
                                    n[2][3].add(a(0, e, p(i) ? i : I))
                            }
                            )).promise()
                        },
                        promise: function (e) {
            ...
            when: function (e) {
                ...
                if (t <= 1 && (z(e, a.done(s(n)).resolve, a.reject, !t),
    ...
    w.fn.ready = function (e) {
        ...
        w.ready.then = F.then,
        "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(w.ready) : (g.addEventListener("DOMContentLoaded", H),
        ...
        w.fn.extend({
            data: function (e, t) {
                ...
                return "object" == typeof e ? this.each((function () {
                    ...
                    var n;
                    if (r && void 0 === t)
                        return void 0 !== (n = G.get(r, e)) || void 0 !== (n = Q(r, e)) ? n : void 0;
                    this.each((function () {
                        G.set(this, e, t)
                    }
                    ))
        ...
        w.extend({
            queue: function (e, t, n) {
                ...
                if (e)
                    return t = (t || "fx") + "queue",
                        i = Z.get(e, t),
                        n && (!i || Array.isArray(n) ? i = Z.access(e, t, w.makeArray(n)) : i.push(n)),
                        i || []
            },
        ...
        w.fn.extend({
            ...
            promise: function (e, t) {
                ...
                for ("string" != typeof e && (t = e,
                    e = void 0),
                    e = e || "fx"; a--;)
                    (n = Z.get(r[a], e + "queueHooks")) && n.empty && (i++,
                        n.empty.add(s));
                return s(),
                    o.promise(t)
            }
    ...
    var le = {};
    function ce(e, t) {
        for (var n, i, o, r, a, s, l, c = [], u = 0, h = e.length; u < h; u++)
            (i = e[u]).style && (n = i.style.display,
                t ? ("none" === n && (c[u] = Z.get(i, "display") || null,
                    c[u] || (i.style.display = "")),
                    "" === i.style.display && ae(i) && (c[u] = (l = a = r = void 0,
                        a = (o = i).ownerDocument,
                        s = o.nodeName,
    ...
    var ue, he, de = /^(?:checkbox|radio)$/i, fe = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, pe = /^$|^module$|\/(?:java|ecma)script/i;
    ...
    ve.tbody = ve.tfoot = ve.colgroup = ve.caption = ve.thead,
        ve.th = ve.td,
        f.option || (ve.optgroup = ve.option = [1, "<select multiple='multiple'>", "</select>"]);
    var ye = /<|&#?\w+;/;
    function be(e, t, n, i, o) {
        for (var r, a, s, l, c, u, h = t.createDocumentFragment(), d = [], f = 0, p = e.length; f < p; f++)
            if ((r = e[f]) || 0 === r)
                if ("object" === b(r))
                ...
                handler: function (e) {
                    ...
                    if (1 & e.isTrigger && this[t]) {
                        if (a.length)
                            ...
                            i = n(this, t),
                            this[t](),
                            a !== (r = Z.get(this, t)) || i ? Z.set(this, t, !1) : r = {},
                            a !== r)
                            return e.stopImmediatePropagation(),
                                e.preventDefault(),
                                r && r.value
                    } else
                        a.length && (Z.set(this, t, {
    ...
    w.event = {
        ...
        add: function (e, t, n, i, o) {
            var r, a, s, l, c, u, h, d, f, p, v, g = Z.get(e);
            if (Y(e))
        ...
        remove: function (e, t, n, i, o) {
            var r, a, s, l, c, u, h, d, f, p, v, g = Z.hasData(e) && Z.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(M) || [""]).length; c--;)
                    if (f = v = (s = xe.exec(t[c]) || [])[1],
                        p = (s[2] || "").split(".").sort(),
                        f) {
                        ...
                        a && !d.length && (h.teardown && !1 !== h.teardown.call(e, p, g.handle) || w.removeEvent(e, f, g.handle),
                            delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function (e) {
            var t, n, i, o, r, a, s = new Array(arguments.length), l = w.event.fix(e), c = (Z.get(this, "events") || Object.create(null))[l.type] || [], u = w.event.special[l.type] || {};
            for (s[0] = l,
                ...
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        for (r = [],
                            a = {},
                            n = 0; n < l; n++)
                            void 0 === a[o = (i = t[n]).selector + " "] && (a[o] = i.needsContext ? -1 < w(o, this).index(c) : w.find(o, this, null, [c]).length),
                                a[o] && r.push(i);
                        r.length && s.push({
                            elem: c,
                            handlers: r
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && $(t, "input") && Se(t, "click", we),
                        !1
                },
                trigger: function (e) {
                    var t = this || e;
                    return de.test(t.type) && t.click && $(t, "input") && Se(t, "click"),
                        !0
                },
                _default: function (e) {
                    var t = e.target;
                    return de.test(t.type) && t.click && $(t, "input") && Z.get(t, "click") || $(t, "a")
                }
            },
            beforeunload: {
    ...
    function Ne(e, t, n, i) {
        t = r(t);
        var o, a, s, l, c, u, h = 0, d = e.length, v = d - 1, g = t[0], m = p(g);
        if (m || 1 < d && "string" == typeof g && !f.checkClone && $e.test(g))
        ...
        if (d && (a = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild,
            1 === o.childNodes.length && (o = a),
            a || i)) {
            for (l = (s = w.map(ge(o, "script"), Pe)).length; h < d; h++)
                c = o,
                    h !== v && (c = w.clone(c, !0, !0),
                        l && w.merge(s, ge(c, "script"))),
                    n.call(e[h], c, h);
            if (l)
                for (u = s[s.length - 1].ownerDocument,
                    ...
                    h = 0; h < l; h++)
                    c = s[h],
                        pe.test(c.type || "") && !Z.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    w.extend({
        ...
        clone: function (e, t, n) {
            var i, o, r, a, s, l, c, u = e.cloneNode(!0), h = oe(e);
            ...
            if (t)
                if (n)
                    ...
                    Oe(e, u);
            return 0 < (a = ge(u, "script")).length && me(a, !h && ge(e, "script")),
                u
        },
    ...
    function Re(e, t, n) {
        ...
        return (n = n || je(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || oe(e) || (a = w.style(e, t)),
            !f.pixelBoxStyles() && Me.test(a) && ze.test(t) && (i = s.width,
                o = s.minWidth,
                r = s.maxWidth,
    ...
    !function () {
        ...
        var i, o, r, a, s, l, c = g.createElement("div"), u = g.createElement("div");
    ...
    var He = ["Webkit", "Moz", "ms"]
        ...
        , We = {};
    function Be(e) {
        return w.cssProps[e] || We[e] || (e in qe ? e : We[e] = function (e) {
    ...
    function Ke(e, t, n) {
        ...
        return (!f.boxSizingReliable() && o || !f.reliableTrDimensions() && $(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === w.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === w.css(e, "boxSizing", !1, i),
            (r = s in e) && (a = e[s])),
            (a = parseFloat(a) || 0) + Ge(e, t, n || (o ? "border" : "content"), r, i, a) + "px"
    }
    ...
    w.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var o, r, a, s = U(t), l = Ue.test(t), c = e.style;
                if (l || (t = Be(s)),
        ...
        w.each(["height", "width"], (function (e, t) {
            w.cssHooks[t] = {
                get: function (e, n, i) {
                    if (n)
                        return !Xe.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ke(e, t, i) : Ie(e, Ye, (function () {
                            return Ke(e, t, i)
                        }
                        ))
                },
                set: function (e, n, i) {
                    var o, r = je(e), a = !f.scrollboxSize() && "absolute" === r.position, s = (a || i) && "border-box" === w.css(e, "boxSizing", !1, r), l = i ? Ge(e, t, i, s, r) : 0;
                    return s && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(r[t]) - Ge(e, t, "border", !1, r) - .5)),
        ...
        w.fx.step = {};
    var Qe, et, tt, nt, it = /^(?:toggle|show|hide)$/, ot = /queueHooks$/;
    function rt() {
        et && (!1 === g.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(rt) : e.setTimeout(rt, w.fx.interval),
            w.fx.tick())
    }
    function at() {
    ...
    function ct(e, t, n) {
        var i, o, r = 0, a = ct.prefilters.length, s = w.Deferred().always((function () {
            delete l.elem
        }
        )), l = function () {
            if (o)
                return !1;
            for (var t = Qe || at(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, a = c.tweens.length; r < a; r++)
                c.tweens[r].run(i);
        ...
        for (function (e, t) {
            ...
            if (i = ct.prefilters[r].call(c, e, u, c.opts))
                return p(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                    i;
        return w.map(u, lt, c),
    ...
    w.Animation = w.extend(ct, {
        ...
        prefilters: [function (e, t, n) {
            var i, o, r, a, s, l, c, u, h = "width" in t || "height" in t, d = this, f = {}, p = e.style, v = e.nodeType && ae(e), g = Z.get(e, "fxshow");
            ...
            if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
                for (i in h && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY],
                    ...
                    "none" === (u = w.css(e, "display")) && (c ? u = c : (ce([e], !0),
                        ...
                        u = w.css(e, "display"),
                        ce([e]))),
                    ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (d.done((function () {
                        p.display = c
                    }
                    )),
                        null == c && (u = p.display,
        ...
        w.fn.extend({
            ...
            finish: function (e) {
                return !1 !== e && (e = e || "fx"),
                    this.each((function () {
                        var t, n = Z.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = w.timers, a = i ? i.length : 0;
                        for (n.finish = !0,
                            w.queue(this, e, []),
    ...
    w.fn.extend({
        ...
        w.fn.extend({
            ...
            toggleClass: function (e, t) {
                ...
                return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : p(e) ? this.each((function (n) {
                    ...
                    if (i)
                        ...
                        void 0 !== e && "boolean" !== n || ((t = vt(this)) && Z.set(this, "__className__", t),
            ...
            hasClass: function (e) {
                var t, n, i = 0;
                for (t = " " + e + " "; n = this[i++];)
                    if (1 === n.nodeType && -1 < (" " + pt(vt(n)) + " ").indexOf(t))
                        return !0;
                return !1
            }
        });
    ...
    w.extend(w.event, {
        trigger: function (t, n, i, o) {
            var r, a, s, l, c, h, d, f, m = [i || g], y = u.call(t, "type") ? t.type : t, b = u.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = f = s = i = i || g,
                3 !== i.nodeType && 8 !== i.nodeType && !yt.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(),
                    b.sort()),
                    c = y.indexOf(":") < 0 && "on" + y,
                ...
                if (!o && !d.noBubble && !v(i)) {
                    for (l = d.delegateType || y,
                        ...
                        m.push(a),
                            s = a;
                    s === (i.ownerDocument || g) && m.push(s.defaultView || s.parentWindow || e)
                }
                for (r = 0; (a = m[r++]) && !t.isPropagationStopped();)
                    f = a,
                        t.type = 1 < r ? l : d.bindType || y,
                        (h = (Z.get(a, "events") || Object.create(null))[t.type] && Z.get(a, "handle")) && h.apply(a, n),
                        (h = c && a[c]) && h.apply && Y(a) && (t.result = h.apply(a, n),
                            !1 === t.result && t.preventDefault());
                return t.type = y,
                    o || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(m.pop(), n) || !Y(i) || c && p(i[y]) && !v(i) && ((s = i[c]) && (i[c] = null),
                        w.event.triggered = y,
        ...
        w.fn.extend({
            ...
            serializeArray: function () {
                return this.map((function () {
                    ...
                    var e = this.type;
                    return this.name && !w(this).is(":disabled") && Et.test(this.nodeName) && !St.test(e) && (this.checked || !de.test(e))
                }
                )).map((function (e, t) {
                    var n = w(this).val();
        ...
        w.extend({
            ...
            ajax: function (t, n) {
                "object" == typeof t && (n = t,
                    t = void 0),
                    n = n || {};
                var i, o, r, a, s, l, c, u, h, d, f = w.ajaxSetup({}, n), p = f.context || f, v = f.context && (p.nodeType || p.jquery) ? w(p) : w.event, m = w.Deferred(), y = w.Callbacks("once memory"), b = f.statusCode || {}, x = {}, k = {}, C = "canceled", T = {
                    readyState: 0,
                ...
                for (h in (u = w.event && f.global) && 0 == w.active++ && w.event.trigger("ajaxStart"),
                    ...
                    f.hasContent ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(At, "+")) : (d = f.url.slice(o.length),
                        f.data && (f.processData || "string" == typeof f.data) && (o += (kt.test(o) ? "&" : "?") + f.data,
                            delete f.data),
                        !1 === f.cache && (o = o.replace(Pt, "$1"),
                            d = (kt.test(o) ? "&" : "?") + "_=" + wt.guid++ + d),
                        f.url = o + d),
                    f.ifModified && (w.lastModified[o] && T.setRequestHeader("If-Modified-Since", w.lastModified[o]),
                ...
                function S(t, n, a, l) {
                    ...
                    c || (c = !0,
                        ...
                        h ? (f.ifModified && ((k = T.getResponseHeader("Last-Modified")) && (w.lastModified[o] = k),
                            (k = T.getResponseHeader("etag")) && (w.etag[o] = k)),
                        ...
                        T.status = t,
                        T.statusText = (n || C) + "",
                        h ? m.resolveWith(p, [d, C, T]) : m.rejectWith(p, [T, C, g]),
                        T.statusCode(b),
                        b = void 0,
                        u && v.trigger(h ? "ajaxSuccess" : "ajaxError", [T, f, h ? d : g]),
                        y.fireWith(p, [T, C]),
    ...
    w.ajaxSetup({
        ...
        w.ajaxPrefilter("json jsonp", (function (t, n, i) {
            var o, r, a, s = !1 !== t.jsonp && (Xt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
            if (s || "jsonp" === t.dataTypes[0])
                return o = t.jsonpCallback = p(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback,
                    s ? t[s] = t[s].replace(Xt, "$1" + o) : !1 !== t.jsonp && (t.url += (kt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
        ...
        f.createHTMLDocument = ((Wt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
            2 === Wt.childNodes.length),
        w.parseHTML = function (e, t, n) {
            return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t,
                t = !1),
                t || (f.createHTMLDocument ? ((i = (t = g.implementation.createHTMLDocument("")).createElement("base")).href = g.location.href,
        ...
        w.offset = {
            setOffset: function (e, t, n) {
                var i, o, r, a, s, l, c = w.css(e, "position"), u = w(e), h = {};
                "static" === c && (e.style.position = "relative"),
                    s = u.offset(),
                    r = w.css(e, "top"),
                    l = w.css(e, "left"),
                    ("absolute" === c || "fixed" === c) && -1 < (r + l).indexOf("auto") ? (a = (i = u.position()).top,
            ...
            return this.each((function () {
                ...
                t.waypoint((function (r) {
                    !function () {
                        ...
                        o.beginAt > s && (o.beginAt = s);
                        var u = /[0-9]+:[0-9]+:[0-9]+/.test(s);
                        if (u) {
                            var h = s.split(":")
                                , d = 1;
                            for (n = 0; h.length > 0;)
                        ...
                        for (var f = a; f >= o.beginAt / s * a; f--) {
                            var p = parseFloat(s / a * f).toFixed(c);
                            if (u) {
                                p = parseInt(n / a * f);
                                var v = parseInt(p / 3600) % 24
                                    , g = parseInt(p / 60) % 60
                                    , m = parseInt(p % 60, 10);
                                p = (v < 10 ? "0" + v : v) + ":" + (g < 10 ? "0" + g : g) + ":" + (m < 10 ? "0" + m : m)
                            }
                            if (l)
                                for (; /(\d+)(\d{3})/.test(p.toString());)
                                    p = p.toString().replace(/(\d+)(\d{3})/, "$1,$2");
                            i.formatter && (p = i.formatter.call(this, p)),
                                r.unshift(p)
                        }
                        t.data("counterup-nums", r),
                            ...
                            t.data("counterup-func", (function () {
                                t.data("counterup-nums") ? (t.html(t.data("counterup-nums").shift()),
                                    t.data("counterup-nums").length ? setTimeout(t.data("counterup-func"), o.delay) : (t.data("counterup-nums", null),
                                        t.data("counterup-func", null),
                                        i.callback.call(this))) : i.callback.call(this)
                            }
                            )),
                ...
                if (!$this.data("tabslet-init")) {
                    ...
                    var fn = eval((function (e, t) {
                        ...
                        n.trigger("_before"),
                            ...
                            _tabs.hide(),
                            i = elements.index(n);
                        var o = t || n.find("a").attr($this.opts.attribute);
                        return $this.opts.deeplinking && (location.hash = o),
                            $this.opts.animation ? _container.find(o).animate({
                                opacity: "show"
                            }, "slow", (function () {
                                n.trigger("_after")
                            }
    ...
    function (e, t) {
        ...
        var w = function (e) {
            ...
            , k = function e() {
                for (var t = !1, n = arguments.length, o = new Array(n), r = 0; r < n; r++)
                    o[r] = arguments[r];
                "boolean" == typeof o[0] && (t = o.shift());
                var a = o[0];
                if (!a || "object" !== i(a))
                    throw new Error("extendee must be an object");
                for (var s = o.slice(1), l = s.length, c = 0; c < l; c++) {
                    var u = s[c];
                    for (var h in u)
                        if (u.hasOwnProperty(h)) {
                            var d = u[h];
                            if (t && (Array.isArray(d) || w(d))) {
                                var f = Array.isArray(d) ? [] : {};
                                a[h] = e(!0, a.hasOwnProperty(h) ? a[h] : f, d)
                            } else
                                a[h] = d
                        }
                }
            ...
            , P = function () {
                    ...
                    o(this, e),
                        ...
                        this._pointerStart = function (e) {
                            if (!(e.buttons > 0 && 0 !== e.button)) {
                                ...
                                )) || n._triggerPointerStart(t, e) && (window.addEventListener("mousemove", n._move),
                        ...
                        this._touchStart = function (e) {
                            for (var t = 0, i = Array.from(e.changedTouches || []); t < i.length; t++) {
                                var o = i[t];
                                n._triggerPointerStart(new E(o), e)
                            }
                        }
                        ,
                        this._move = function (e) {
                            var t, i = n.currentPointers.slice(), o = L(e) ? Array.from(e.changedTouches).map((function (e) {
                                return new E(e)
                            }
                            )) : [new E(e)], r = [], a = x(o);
                            try {
                        ...
                        this._triggerPointerEnd = function (e, t) {
                            ...
                            return !(i < 0 || (n.currentPointers.splice(i, 1),
                        ...
                        this._pointerEnd = function (e) {
                            e.buttons > 0 && 0 !== e.button || n._triggerPointerEnd(new E(e), e) && (window.removeEventListener("mousemove", n._move, {
                                passive: !1
                            }),
                        ...
                        this._touchEnd = function (e) {
                            for (var t = 0, i = Array.from(e.changedTouches || []); t < i.length; t++) {
                                var o = i[t];
                                n._triggerPointerEnd(new E(o), e)
                            }
                        }
                        ,
                        this._startCallback = a,
                ...
                return a(e, [{
                    ...
                    value: function (e, t) {
                        return !!this._startCallback(e, t) && (this.currentPointers.push(e),
            ...
            , O = function () {
                function e() {
                    ...
                    for (var n = 0, i = ["on", "once"]; n < i.length; n++)
                        for (var r = i[n], a = 0, s = Object.entries(this.options[r] || {}); a < s.length; a++) {
                            var l = s[a];
                            this[r].apply(this, m(l))
                        }
                }
                return a(e, [{
                    key: "option",
                    value: function (e, t) {
                        e = String(e);
                        var n = _(e, this.options);
                        if ("function" == typeof n) {
                            for (var i, o = arguments.length, r = new Array(o > 2 ? o - 2 : 0), a = 2; a < o; a++)
                                r[a - 2] = arguments[a];
                            n = (i = n).call.apply(i, [this, this].concat(r))
                        }
                        return void 0 === n ? t : n
                    }
                }, {
                    ...
                    value: function (e) {
                        ...
                        return (e = String(e).replace(/\{\{(\w+).?(\w+)?\}\}/g, (function (e, i, o) {
                            var r = "";
                            o ? r = t.option("".concat(i[0] + i.toLowerCase().substring(1), ".l10n.").concat(o)) : i && (r = t.option("l10n.".concat(i))),
                                r || (r = e);
                            for (var a = 0; a < n.length; a++)
                                r = r.split(n[a][0]).join(n[a][1]);
                            return r
                        }
                    ...
                    value: function (e) {
                        for (var t = arguments.length, n = new Array(t > 1 ? t - 1 : 0), i = 1; i < t; i++)
                            n[i - 1] = arguments[i];
                        var o, r = x(m(this.events[e] || []).slice());
                        try {
                            for (r.s(); !(o = r.n()).done;) {
                                var a = o.value;
                                if (a && !1 === a.call.apply(a, [this, this].concat(n)))
                                    return !1
                            }
                        } catch (e) {
                            r.e(e)
                    ...
                    value: function (e) {
                        for (var t = {}, n = 0, i = Object.entries(e || {}); n < i.length; n++) {
                            var o = g(i[n], 2)
                                , r = o[0]
                                , a = o[1];
                            !1 === this.options[r] || this.plugins[r] || (this.options[r] = k({}, a.defaults || {}, this.options[r]),
                                t[r] = new a(this))
                        }
                        for (var s = 0, l = Object.entries(t); s < l.length; s++) {
                            var c = g(l[s], 2);
                            c[0],
                                c[1].attach(this)
                        }
                        return this.plugins = Object.assign({}, this.plugins, t),
                            this
                    }
                }, {
                    key: "detachPlugins",
            ...
            , D = function (e) {
                ...
                function i(e) {
                    ...
                    o(this, i),
                        (n = t.call(this, k(!0, {}, N, r))).state = "init",
                        n.$container = e;
                    for (var a = 0, s = ["onLoad", "onWheel", "onClick"]; a < s.length; a++) {
                        var l = s[a];
                        n[l] = n[l].bind(h(n))
                    }
                    return n.initLayout(),
                        ...
                        n.attachEvents(),
                        n.trigger("ready"),
                        !1 === n.option("centerOnStart") ? n.state = "ready" : n.panTo({
                            friction: 0
                        }),
                        e.__Panzoom = h(n),
                        n
                ...
                return a(i, [{
                    ...
                    value: function () {
                        ...
                        i || !1 === this.option("wrapInner") || ((i = document.createElement("div")).classList.add("panzoom__viewport"),
                            (n = i).append.apply(n, m(e.childNodes)),
                            e.appendChild(i)),
                    ...
                    value: function (e) {
                        if (!(e.defaultPrevented || document.activeElement && document.activeElement.closest("[contenteditable]")))
                            if (!this.option("textSelection") || !window.getSelection().toString().length || e.target && e.target.hasAttribute("data-fancybox-close")) {
                                ...
                                !1 !== this.trigger("click", e) && this.option("zoom") && "toggleZoom" === this.option("click") && (e.preventDefault(),
                                    e.stopPropagation(),
                    ...
                    value: function (e) {
                        ...
                        if (t < 0 && Math.abs(n - this.option("minScale")) < .01 || t > 0 && Math.abs(n - this.option("maxScale")) < .01 ? (this.changedDelta += Math.abs(t),
                            i = n) : (this.changedDelta = 0,
                                i = Math.max(Math.min(i, this.option("maxScale")), this.option("minScale"))),
                            !(this.changedDelta > this.option("wheelLimit")) && (e.preventDefault(),
                                i !== n)) {
                    ...
                    value: function () {
                        ...
                        var t = new P(this.$container, {
                            start: function (n, i) {
                                ...
                                if (!t.currentPointers.length) {
                                    ...
                                    if (e.option("textSelection") && function (e, t, n) {
                                        for (var i = e.childNodes, o = document.createRange(), r = 0; r < i.length; r++) {
                                            var a = i[r];
                                            if (a.nodeType === Node.TEXT_NODE) {
                                                o.selectNodeContents(a);
                                                var s = o.getBoundingClientRect();
                                                if (t >= s.left && n >= s.top && t <= s.right && n <= s.bottom)
                                                    return a
                                            }
                                        }
                                        return !1
                                ...
                                return !T(o) && !1 !== e.trigger("touchStart", i) && ("mousedown" === i.type && i.preventDefault(),
                                    e.state = "pointerdown",
                                    e.resetDragPosition(),
                            ...
                            move: function (n, i, o) {
                                if ("pointerdown" === e.state)
                                    if (!1 !== e.trigger("touchMove", o)) {
                                        if (!(i.length < 2 && !0 === e.option("panOnlyZoomed") && e.content.width <= e.viewport.width && e.content.height <= e.viewport.height && e.transform.scale <= e.option("baseScale")) && (!(i.length > 1) || e.option("zoom") && !1 !== e.option("pinchToZoom"))) {
                                            var r = A(n[0], n[1])
                                                , a = A(i[0], i[1])
                                                , s = a.clientX - r.clientX
                                                , l = a.clientY - r.clientY
                                                , c = $(n[0], n[1])
                                                , u = $(i[0], i[1])
                                                , h = c && u ? u / c : 1;
                                            e.dragOffset.x += s,
                                                e.dragOffset.y += l,
                                                e.dragOffset.scale *= h,
                                                e.dragOffset.time = Date.now() - e.dragPosition.time;
                                            var d = 1 === e.dragStart.scale && e.option("lockAxis");
                                            if (d && !e.lockAxis) {
                                                if (Math.abs(e.dragOffset.x) < 6 && Math.abs(e.dragOffset.y) < 6)
                                                    return void o.preventDefault();
                                                var f = Math.abs(180 * Math.atan2(e.dragOffset.y, e.dragOffset.x) / Math.PI);
                                                e.lockAxis = f > 45 && f < 135 ? "y" : "x"
                                            }
                                            if ("xy" === d || "y" !== e.lockAxis) {
                                                if (o.preventDefault(),
                                                    o.stopPropagation(),
                                                    ...
                                                    i.length > 1) {
                                                    var p = A(t.startPointers[0], t.startPointers[1])
                                                        , v = p.clientX - e.dragStart.rect.x
                                                        , g = p.clientY - e.dragStart.rect.y
                                                        , m = e.getZoomDelta(e.content.scale * e.dragOffset.scale, v, g)
                                                        , y = m.deltaX
                                                        , b = m.deltaY;
                                                    e.dragPosition.x -= y,
                                                        e.dragPosition.y -= b,
                                                        e.dragPosition.midPoint = a
                                                } else
                                                    e.setDragResistance();
                                                e.transform = {
                                                    x: e.dragPosition.x,
                                ...
                                if ("pointerdown" === e.state)
                                    if (e._dragOffset = n({}, e.dragOffset),
                                        t.currentPointers.length)
                                        e.resetDragPosition();
                                    else if (e.state = "decel",
                                        ...
                                        var r = e.option("minScale");
                                        if (e.transform.scale < r)
                                            e.zoomTo(r, {
                                                friction: .64
                                            });
                                        else {
                                            var a = e.option("maxScale");
                                            if (e.transform.scale - a > .01) {
                                                var s = e.dragPosition.midPoint || i
                    ...
                    value: function () {
                        ...
                        this.resizeObserver || (this.resizeObserver = new S((function () {
                            e.updateTimer || (e.updateTimer = setTimeout((function () {
                                ...
                                t.width && t.height ? ((Math.abs(t.width - e.container.width) > 1 || Math.abs(t.height - e.container.height) > 1) && (e.isAnimating() && e.endAnimation(!0),
                                    e.updateMetrics(),
                                    e.panTo({
                                        x: e.content.x,
                                        y: e.content.y,
                    ...
                    value: function (e) {
                        ...
                        var t, i = this.$container, o = this.$content, r = this.$viewport, a = o instanceof HTMLImageElement, s = this.option("zoom"), l = this.option("resizeParent", s), c = this.option("width"), u = this.option("height"), h = c || (t = o,
                            Math.max(parseFloat(t.naturalWidth || 0), parseFloat(t.width && t.width.baseVal && t.width.baseVal.value || 0), parseFloat(t.offsetWidth || 0), parseFloat(t.scrollWidth || 0))), d = u || function (e) {
                        ...
                        var p = o.getBoundingClientRect()
                            ...
                            , g = r == i ? v : i.getBoundingClientRect()
                            , m = Math.max(r.offsetWidth, C(v.width))
                            , y = Math.max(r.offsetHeight, C(v.height))
                            , b = window.getComputedStyle(r);
                        if (m -= parseFloat(b.paddingLeft) + parseFloat(b.paddingRight),
                            y -= parseFloat(b.paddingTop) + parseFloat(b.paddingBottom),
                            this.viewport.width = m,
                            this.viewport.height = y,
                            s) {
                            if (Math.abs(h - p.width) > .1 || Math.abs(d - p.height) > .1) {
                                ...
                                }(h, d, Math.min(h, p.width), Math.min(d, p.height));
                                c = C(x.width),
                                    u = C(x.height)
                            }
                            Object.assign(o.style, {
                        ...
                        if (l && (Object.assign(r.style, {
                            ...
                            a && s && "function" != typeof this.options.maxScale) {
                    ...
                    value: function () {
                        ...
                        var a = C(this.content.scale / (this.content.width / this.content.fitWidth), 1e7);
                        null === i && (i = this.content.width * a * .5),
                            null === r && (r = this.content.height * a * .5);
                        var s = this.getZoomDelta(e, i, r)
                            , l = s.deltaX
                            , c = s.deltaY;
                        i = this.content.x - l,
                            r = this.content.y - c,
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
                            ...
                            , o = e.y
                            , r = void 0 === o ? this.content.y : o
                            , a = e.scale
                            , s = e.friction
                            , l = void 0 === s ? this.option("friction") : s
                            , c = e.ignoreBounds
                            , u = void 0 !== c && c;
                        if (a = a || this.content.scale || 1,
                            !u) {
                            var h = this.getBounds(a)
                                , d = h.boundX
                                , f = h.boundY;
                            d && (i = Math.max(Math.min(i, d.to), d.from)),
                                f && (r = Math.max(Math.min(r, f.to), f.from))
                        }
                        this.friction = l,
                            this.transform = n(n({}, this.transform), {}, {
                                x: i,
                                y: r,
                                scale: a
                            }),
                            l ? (this.state = "panning",
                                this.velocity = {
                                    ...
                                    y: (1 / this.friction - 1) * (r - this.content.y),
                    ...
                    value: function () {
                        if ("decel" === this.state) {
                            var e, t, n, i, o = this.option("bounceForce"), r = this.getBounds(Math.max(this.transform.scale, this.content.scale)), a = r.boundX, s = r.boundY;
                            if (a && (e = this.content.x < a.from,
                                t = this.content.x > a.to),
                                s && (n = this.content.y < s.from,
                                    i = this.content.y > s.to),
                                e || t) {
                                var l = ((e ? a.from : a.to) - this.content.x) * o
                                    , c = this.content.x + (this.velocity.x + l) / this.friction;
                                c >= a.from && c <= a.to && (l += this.velocity.x),
                                    this.velocity.x = l,
                                    this.recalculateTransform()
                            }
                            if (n || i) {
                                var u = ((n ? s.from : s.to) - this.content.y) * o
                                    , h = this.content.y + (u + this.velocity.y) / this.friction;
                                h >= s.from && h <= s.to && (u += this.velocity.y),
                                    this.velocity.y = u,
                                    this.recalculateTransform()
                            }
                        }
                    ...
                    value: function () {
                        if ("pointerdown" === this.state) {
                            var e, t, n, i, o = this.getBounds(this.dragPosition.scale), r = o.boundX, a = o.boundY;
                            if (r && (e = this.dragPosition.x < r.from,
                                t = this.dragPosition.x > r.to),
                                a && (n = this.dragPosition.y < a.from,
                                    i = this.dragPosition.y > a.to),
                                (e || t) && (!e || !t)) {
                                var s = e ? r.from : r.to
                                    , l = s - this.dragPosition.x;
                                this.dragPosition.x = s - .3 * l
                            }
                            if ((n || i) && (!n || !i)) {
                                var c = n ? a.from : a.to
                    ...
                    value: function (e) {
                        var t, i, o, r, a;
                        e ? (t = C(this.transform.x),
                            i = C(this.transform.y),
                            ...
                            t = C(this.content.x),
                            i = C(this.content.y),
                            e && this.option("zoom") ? (r = C(this.content.fitWidth * o),
                                a = C(this.content.fitHeight * o),
                                this.content.width = r,
                                ...
                                })) : this.$content.style.transform = "translate3d(".concat(t, "px, ").concat(i, "px, 0) scale(").concat(o, ")"),
            ...
            , j = function () {
                ...
                return a(e, [{
                    ...
                    value: function (e) {
                        ...
                        return (t = i.classList).add.apply(t, m(o.split(" "))),
                            i.setAttribute("tabindex", "0"),
                            i.innerHTML = this.carousel.localize(this.option("".concat(e, "Tpl"))),
                            i.addEventListener("click", (function (t) {
                                t.preventDefault(),
                                    t.stopPropagation(),
                                    n.carousel["slide".concat("next" === e ? "Next" : "Prev")]()
                            }
                            )),
                            i
                    }
                    ...
                    value: function () {
                        ...
                        this.$container || (this.$container = document.createElement("div"),
                            (e = this.$container.classList).add.apply(e, m(this.option("classNames.main").split(" "))),
                    ...
                    value: function () {
                        ...
                        e <= 1 || e > 1 && this.carousel.elemDimWidth < this.carousel.wrapDimWidth && !Number.isInteger(this.carousel.option("slidesPerPage")) ? this.cleanup() : (this.build(),
                            ...
                            this.carousel.option("infiniteX", this.carousel.option("infinite")) || (this.carousel.page <= 0 && this.$prev.setAttribute("disabled", ""),
                                this.carousel.page >= e - 1 && this.$next.setAttribute("disabled", "")))
                    }
                }, {
                    key: "cleanup",
                    value: function () {
            ...
            return a(e, [{
                ...
                value: function () {
                    ...
                    if (!(this.carousel.pages.length < this.carousel.option("Dots.minSlideCount"))) {
                        ...
                        return t.classList.add("carousel__dots"),
                        ...
                        if (o > i)
                            ...
                            for (var a = function (t) {
                                ...
                                n.classList.add("carousel__dot"),
                                    ...
                                    n.setAttribute("title", e.carousel.localize("{{GOTO}}", [["%d", t + 1]])),
                                    n.addEventListener("keydown", (function (e) {
                                        var t, i = e.code;
                                        "Enter" === i || "NumpadEnter" === i ? t = n : "ArrowRight" === i ? t = n.nextSibling : "ArrowLeft" === i && (t = n.previousSibling),
                                            t && t.click()
                                    }
                                    )),
                ...
                return a(e, [{
                    ...
                    value: function (e) {
                        this.selectedIndex = e,
                            m(this.nav.slides).filter((function (e) {
                    ...
                    value: function (e) {
                        ...
                        (t.target || t.nav) && (t.target ? this.addAsNavFor(t.target) : t.nav && this.addAsTargetFor(t.nav),
        ...
        var R = {
            ...
            , H = function (e) {
                ...
                function i(e) {
                    ...
                    if (o(this, i),
                        r = k(!0, {}, F, r),
                        (n = t.call(this, r)).state = "init",
                        n.$container = e,
                        !(n.$container instanceof HTMLElement))
                        throw new Error("No root element provided");
                    return n.slideNext = M(n.slideNext.bind(h(n)), 250),
                        n.slidePrev = M(n.slidePrev.bind(h(n)), 250),
                        n.init(),
                        e.__Carousel = h(n),
                        n
                }
                return a(i, [{
                    ...
                    key: "initLayout",
                    value: function () {
                        var e, t, n, i, o = this.option("prefix"), r = this.option("classNames");
                        this.$viewport = this.option("viewport") || this.$container.querySelector(".".concat(o).concat(r.viewport)),
                            this.$viewport || (this.$viewport = document.createElement("div"),
                                (e = this.$viewport.classList).add.apply(e, m((o + r.viewport).split(" "))),
                                (t = this.$viewport).append.apply(t, m(this.$container.childNodes)),
                                this.$container.appendChild(this.$viewport)),
                            this.$track = this.option("track") || this.$container.querySelector(".".concat(o).concat(r.track)),
                            this.$track || (this.$track = document.createElement("div"),
                                (n = this.$track.classList).add.apply(n, m((o + r.track).split(" "))),
                                (i = this.$track).append.apply(i, m(this.$viewport.childNodes)),
                    ...
                    value: function () {
                        ...
                        this.slides.forEach((function (n, r) {
                            var a = n.$el
                                , s = n.isDom || !e ? t.getSlideMetrics(a) : e;
                            n.index = r,
                                n.width = s,
                                n.left = i,
                                e = s,
                        ...
                        var r = Math.max(this.$track.offsetWidth, C(this.$track.getBoundingClientRect().width))
                            , a = getComputedStyle(this.$track);
                        r -= parseFloat(a.paddingLeft) + parseFloat(a.paddingRight),
                            this.contentWidth = i,
                            this.viewportWidth = r;
                        var s = []
                            , l = this.option("slidesPerPage");
                        if (Number.isInteger(l) && i > r)
                            ...
                            for (var u = 0, h = 0, d = 0; d < this.slides.length; d += 1) {
                                var f = this.slides[d];
                                (!s.length || h + f.width > r) && (s.push({
                                    indexes: [],
                                    slides: []
                                }),
                                    u = s.length - 1,
                        ...
                        s.forEach((function (e, n) {
                            e.index = n,
                                ...
                                p && (e.left += .5 * (r - e.width) * -1),
                                v && !t.option("infiniteX", t.option("infinite")) && i > r && (e.left = Math.max(e.left, 0),
                                    e.left = Math.min(e.left, i - r))
                        }
                        ));
                        var g, y = [];
                        s.forEach((function (e) {
                            var t = n({}, e);
                            g && t.left === g.left ? (g.width += t.width,
                                g.slides = [].concat(m(g.slides), m(t.slides)),
                                g.indexes = [].concat(m(g.indexes), m(t.indexes))) : (t.index = y.length,
                                    g = t,
                                    y.push(t))
                        }
                        )),
                    ...
                    value: function (e) {
                        if (!e) {
                            ...
                            (e = document.createElement("div")).dataset.isTestEl = 1,
                                ...
                                (t = e.classList).add.apply(t, m((this.option("prefix") + this.option("classNames.slide")).split(" "))),
                                i.customClass && (n = e.classList).add.apply(n, m(i.customClass.split(" "))),
                                this.$track.prepend(e)
                        }
                        var o = Math.max(e.offsetWidth, C(e.getBoundingClientRect().width))
                            , r = e.currentStyle || window.getComputedStyle(e);
                        return o = o + (parseFloat(r.marginLeft) || 0) + (parseFloat(r.marginRight) || 0),
                    ...
                    value: function (e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                            ...
                            , r = void 0 === o ? 0 : o
                            , a = t.friction
                            , s = void 0 === a ? this.option("friction") : a;
                    ...
                    value: function () {
                        ...
                        this.Panzoom = new D(this.$container, t),
                            this.Panzoom.on({
                                "*": function (t) {
                    ...
                    value: function () {
                        var e = this
                            ...
                            , s = parseFloat(getComputedStyle(this.$viewport, null).getPropertyValue("padding-right"));
                        this.slides.forEach((function (l) {
                            ...
                            c = i - a,
                                ...
                                c -= o * (n + a + s),
                                u += o * (n + a + s);
                            var d = l.left + l.width > c && l.left < u;
                            c = i + t - a,
                                u = i + t + n + s,
                                c -= o * (n + a + s);
                            var f = r && l.left + l.width > c && l.left < u;
                            c = i - t - a,
                                u = i - t + n + s,
                                c -= o * (n + a + s);
                            var p = r && l.left + l.width > c && l.left < u;
                            f || d || p ? (e.createSlideEl(l),
                                d && (h = 0),
                                f && (h = -1),
                                p && (h = 1),
                                l.left + l.width > i && l.left <= i + n + s && (h = 0)) : e.removeSlideEl(l),
                                l.hasDiff = h
                        }
                        ));
                        var l = 0
                        ...
                        this.slides.forEach((function (e, n) {
                            var i = 0;
                            e.$el ? (n !== l || e.hasDiff ? i = c + e.hasDiff * t : c = 0,
                                e.$el.style.left = Math.abs(i) > .1 ? "".concat(c + e.hasDiff * t, "px") : "",
                                l++) : c += e.width
                        }
                        )),
                        ...
                        if (e) {
                            if (!e.$el) {
                                ...
                                i.dataset.index = e.index,
                                    (t = i.classList).add.apply(t, m((this.option("prefix") + this.option("classNames.slide")).split(" "))),
                                    e.customClass && (n = i.classList).add.apply(n, m(e.customClass.split(" "))),
                                ...
                                return this.$track.insertBefore(i, a && a.$el ? a.index < e.index ? a.$el.nextSibling : a.$el : null),
                                    e.$el = i,
                                    this.trigger("createSlide", e, r),
                                    e
                            }
                            var l, c = e.$el.dataset.index;
                            c && parseInt(c, 10) === e.index || (e.$el.dataset.index = e.index,
                    ...
                    key: "removeSlideEl",
                    value: function (e) {
                        e.$el && !e.isDom && (this.trigger("removeSlide", e),
                            e.$el.remove(),
                            e.$el = null)
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        this.slides.forEach((function (i, o) {
                            var r = i.$el;
                            if (r) {
                                var a = e.pages[e.page];
                                a && a.indexes && a.indexes.indexOf(o) > -1 ? (t && !r.classList.contains(t) && (r.classList.add(t),
                                    e.trigger("selectSlide", i)),
                                    r.removeAttribute(n)) : (t && r.classList.contains(t) && (r.classList.remove(t),
                    ...
                    value: function () {
                        ...
                        if (!(!this.option("infiniteX", this.option("infinite")) || this.pages.length < 2 || e < t)) {
                            var n = this.Panzoom
                                , i = !1;
                            return n.content.x < -1 * (e - t) && (n.content.x += e,
                                this.pageIndex = this.pageIndex - this.pages.length,
                                i = !0),
                                n.content.x > t && (n.content.x -= e,
                                    this.pageIndex = this.pageIndex + this.pages.length,
                                    i = !0),
                    ...
                    value: function (e, t) {
                        ...
                        if (!n && this.pages.length > 1 && e.dragOffset.time < 350 && Math.abs(e.dragOffset.y) < 1 && Math.abs(e.dragOffset.x) > 5)
                    ...
                    value: function (e, t) {
                        ...
                        if (e = (i % a + a) % a,
                            this.option("infiniteX", this.option("infinite")) && s > l) {
                            var c = Math.floor(i / a) || 0
                                , u = s;
                            if (n = this.pages[e].left + c * u,
                                !0 === t && a > 2) {
                            ...
                            e = i = Math.max(0, Math.min(i, a - 1)),
                                n = this.pages.length ? this.pages[e].left : 0;
                        return this.page = e,
                            this.pageIndex = i,
                            null !== o && e !== o && (this.prevPage = o,
        ...
        var q = !("undefined" == typeof window || !window.document || !window.document.createElement)
            , W = null
            , B = ["a[href]", "area[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "button:not([disabled]):not([aria-hidden])", "iframe", "object", "embed", "video", "audio", "[contenteditable]", '[tabindex]:not([tabindex^="-"]):not([disabled]):not([aria-hidden])']
            , X = function (e) {
                if (e && q) {
                    null === W && document.createElement("div").focus({
                        get preventScroll() {
                            return W = !0,
                                !1
                        }
                ...
                return a(e, [{
                    ...
                    value: function () {
                        ...
                        if (i) {
                            var o = ""
                                , r = ""
                                , a = "";
                            n - 1 > .1 && (o = "".concat(t.width * n, "px"),
                                r = "".concat(t.height * n, "px"),
                                a = "translate3d(".concat(t.offsetLeft, "px, ").concat(t.offsetTop, "px, 0) scale(").concat(1 / n, ")")),
                                i.style.width = o,
                                i.style.height = r,
                                i.style.transform = a
                        }
                        ...
                        if (e.cancelable && !(e.touches.length > 1 || 1 !== n)) {
                            ...
                            if (i) {
                                var o = window.getComputedStyle(i)
                                    , r = parseInt(o.getPropertyValue("height"), 10)
                                    , a = e.touches ? e.touches[0].screenY : e.screenY
                                    , s = t <= a && 0 === i.scrollTop
                                    , l = t >= a && i.scrollHeight - i.scrollTop === r;
                                (s || l) && e.preventDefault()
                            } else
                                e.preventDefault()
                        }
                    }
                    ...
                    value: function () {
                        this.pendingUpdate && (cancelAnimationFrame(this.pendingUpdate),
                            this.pendingUpdate = null);
                        var e = this.viewport;
                        e && (e.removeEventListener("resize", this.onResize),
                            this.viewport = null),
            ...
            , Y = function () {
                ...
                return a(e, [{
                    ...
                    key: "getSlides",
                    value: function () {
                        var e, t = [], n = x(this.fancybox.items);
                        try {
                            for (n.s(); !(e = n.n()).done;) {
                                var i = e.value
                                    , o = i.thumb;
        ...
        var V = function (e, t) {
            for (var n = new URL(e), i = new URLSearchParams(n.search), o = new URLSearchParams, r = 0, a = [].concat(m(i), m(Object.entries(t))); r < a.length; r++) {
                var s = g(a[r], 2)
                    , l = s[0]
                    , c = s[1];
            ...
            , G = function () {
                ...
                return a(e, [{
                    ...
                    value: function (e) {
                        ...
                        if (!t || "string" == typeof t) {
                            if (i = t.match(/(?:youtube\.com|youtu\.be|youtube\-nocookie\.com)\/(?:watch\?(?:.*&)?v=|v\/|u\/|embed\/?)?(videoseries\?list=(?:.*)|[\w-]{11}|\?listType=(?:.*)&list=(?:.*))(?:.*)/i)) {
                                ...
                                e.videoId = r,
                                    e.src = "https://www.youtube-nocookie.com/embed/".concat(r, "?").concat(o),
                                    e.thumb = e.thumb || "https://i.ytimg.com/vi/".concat(r, "/mqdefault.jpg"),
                                    e.vendor = "youtube",
                                    n = "video"
                            } else if (i = t.match(/^.+vimeo.com\/(?:\/)?([\d]+)(.*)?/)) {
                                var a = V(t, this.fancybox.option("Html.vimeo"))
                                ...
                                (i = t.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:(?:(?:maps\/(?:place\/(?:.*)\/)?\@(.*),(\d+.?\d+?)z))|(?:\?ll=))(.*)?/i)) ? (e.src = "//maps.google.".concat(i[1], "/?ll=").concat((i[2] ? i[2] + "&z=" + Math.floor(i[3]) + (i[4] ? i[4].replace(/^\//, "&") : "") : i[4] + "").replace(/\?/, "&"), "&output=").concat(i[4] && i[4].indexOf("layer=c") > 0 ? "svembed" : "embed"),
                                    n = "map") : (i = t.match(/(?:maps\.)?google\.([a-z]{2,3}(?:\.[a-z]{2})?)\/(?:maps\/search\/)(.*)/i)) && (e.src = "//maps.google.".concat(i[1], "/maps?q=").concat(i[2].replace("query=", "q=").replace("api=1", ""), "&output=embed"),
                                        n = "map");
                            n || ("#" === t.charAt(0) ? n = "inline" : (i = t.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i)) ? (n = "html5video",
                                e.format = e.format || "video/" + ("ogv" === i[1] ? "ogg" : i[1])) : t.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i) ? n = "image" : t.match(/\.(pdf)((\?|#).*)?$/i) && (n = "pdf")),
                                e.type = n || this.fancybox.option("defaultType", "image"),
                                "html5video" !== n && "video" !== n || (e.video = k({}, this.fancybox.option("Html.video"), e.video),
                                    e._width && e._height ? e.ratio = parseFloat(e._width) / parseFloat(e._height) : e.ratio = e.ratio || e.video.ratio || Z.video.ratio)
                        }
                    }
                }, {
                    key: "onReady",
                    ...
                    value: function (e) {
                        var t;
                        if (e.src instanceof HTMLElement)
                            t = e.src;
                        ...
                        if (t) {
                            if ("clone" === e.type || t.$placeHolder) {
                                ...
                                o = o ? "".concat(o, "--clone") : "clone-".concat(this.fancybox.id, "-").concat(e.index),
                                    t.setAttribute("id", o)
                            } else {
                                var r = document.createElement("div");
                                r.classList.add("fancybox-placeholder"),
                    ...
                    value: function (e) {
                        ...
                        t.showLoading(e),
                            n.onreadystatechange = function () {
                                n.readyState === XMLHttpRequest.DONE && "ready" === t.state && (t.hideLoading(e),
                                    200 === n.status ? t.setContent(e, n.responseText) : t.setError(e, 404 === n.status ? "{{AJAX_NOT_FOUND}}" : "{{AJAX_FORBIDDEN}}"))
                            }
                            ;
                        var i = e.ajax || null;
                    ...
                    value: function (e) {
                        ...
                        if (i.className = "fancybox__iframe",
                            i.setAttribute("id", "fancybox__iframe_".concat(n.id, "_").concat(e.index)),
                            i.setAttribute("allow", "autoplay; fullscreen"),
                            i.setAttribute("scrolling", "auto"),
                            e.$iframe = i,
                            "iframe" !== e.type || !1 === e.preload)
                            return i.setAttribute("src", e.src),
                        ...
                        o.style.visibility = "hidden",
                            ...
                            i.onload = function () {
                                n.hideLoading(e);
                                var o = !1;
                                i.isReady || (i.isReady = !0,
                                    o = !0),
                                    i.src.length && (i.parentNode.style.visibility = "",
                                        t.resizeIframe(e),
                                        o && n.revealContent(e))
                            }
                            ,
                    ...
                    value: function (e) {
                        ...
                        if (t) {
                            ...
                            if (n || i && o) {
                                ...
                                if (o = o || a,
                                    (i = i || r) > r || o > a) {
                                    var s = Math.min(r / i, a / o);
                                    i *= s,
                                        o *= s
                                }
                                Math.abs(i / o - n) > .01 && (n < i / o ? i = o * n : o = i / n),
                                    Object.assign(t.style, {
                                        width: "".concat(i, "px"),
                                        height: "".concat(o, "px")
                                    })
                    ...
                    value: function (e) {
                        ...
                        if (t) {
                            ...
                            var o = t.parentNode
                                , r = o && o.style;
                            if (!1 !== e.preload && !1 !== e.autoSize && r)
                                try {
                                    var a = window.getComputedStyle(o)
                                        , s = parseFloat(a.paddingLeft) + parseFloat(a.paddingRight)
                                        , l = parseFloat(a.paddingTop) + parseFloat(a.paddingBottom)
                                    ...
                                    r.width = "",
                                        ...
                                        h.style.overflow = "",
                                        r.flex = "0 0 auto",
                                        r.height = "".concat(h.scrollHeight, "px"),
                                        i = u.scrollHeight + l
                                } catch (e) { }
                            if (n || i) {
                                var d = {
                                ...
                                n && (d.width = "".concat(n, "px")),
                                    i && (d.height = "".concat(i, "px")),
                                    Object.assign(r, d)
                            }
                        }
                    }
                    ...
                    value: function (e, t) {
                        ...
                        t.slides.forEach((function (e) {
                            e.$el && (e.$iframe && n.resizeIframe(e),
                    ...
                    value: function (e) {
                        ...
                        "video" === e.type && e.$iframe && e.$iframe.contentWindow && function t() {
                            if ("done" === e.state && e.$iframe && e.$iframe.contentWindow) {
                                var n;
                                if (e.$iframe.isReady)
                                    return e.video && e.video.autoplay && (n = "youtube" == e.vendor ? {
                                        event: "command",
                                        func: "playVideo"
                                    } : {
                                        method: "play",
                    ...
                    value: function (e, t, n) {
                        n.xhr && (n.xhr.abort(),
                            n.xhr = null),
                            n.$iframe && (n.$iframe.onload = n.$iframe.onerror = null,
                                n.$iframe.src = "//about:blank",
                                n.$iframe = null);
                        var i = n.$content;
                        "inline" === n.type && i && (i.classList.remove("fancybox__content"),
                            "none" !== i.style.display && (i.style.display = "none")),
                            n.$closeButton && (n.$closeButton.remove(),
                                n.$closeButton = null);
                        var o = i && i.$placeHolder;
                        o && (o.parentNode.insertBefore(i, o),
                            o.remove(),
                            i.$placeHolder = null)
                    }
                }, {
                    ...
                    value: function (e) {
                        try {
                            ...
                            if ("https://player.vimeo.com" === e.origin) {
                                if ("ready" === t.event) {
                                    var n, i = x(document.getElementsByClassName("fancybox__iframe"));
                                    try {
                                        for (i.s(); !(n = i.n()).done;) {
                                            var o = n.value;
                                ...
                                "https://www.youtube-nocookie.com" === e.origin && "onReady" === t.event && (document.getElementById(t.id).isReady = 1)
                        } catch (e) { }
                    }
                }, {
                    key: "attach",
        ...
        var K = function () {
            ...
            return a(e, [{
                ...
                key: "onRemoveSlide",
                value: function (e, t, n) {
                    n.$image && (n.$el.classList.remove(e.option("Image.canZoomInClass")),
                        n.$image.remove(),
                        n.$image = null),
                ...
                value: function (e) {
                    ...
                    if (!(e.isDom || e.html || e.type && "image" !== e.type || e.$image)) {
                        ...
                        if (o) {
                            var r = document.createElement("div");
                            r.classList.add("string" == typeof o ? o : "fancybox__image-wrap"),
                                r.appendChild(i),
                                n.appendChild(r),
                                e.$wrap = r
                        } else
                        ...
                        e.$el.dataset.imageFit = this.fancybox.option("Image.fit"),
                            ...
                            i.complete || i.error ? this.onImageStatusChange(e) : this.fancybox.showLoading(e)
                    }
                }
            }, {
                ...
                value: function (e) {
                    var t = this
                        , n = e.$image;
                    n && "loading" === e.state && (n.complete && n.naturalWidth && n.naturalHeight ? (this.fancybox.hideLoading(e),
                        "contain" === this.fancybox.option("Image.fit") && this.initSlidePanzoom(e),
                        e.$el.addEventListener("wheel", (function (n) {
                ...
                value: function (e) {
                    var t = this;
                    e.Panzoom || (e.Panzoom = new D(e.$el, k(!0, this.fancybox.option("Image.Panzoom", {}), {
                        viewport: e.$wrap,
                        content: e.$image,
                        width: e._width,
                        height: e._height,
                        ...
                        e.Panzoom.on("afterUpdate", (function () {
                            t.handleCursor(e),
                                t.fancybox.trigger("Image.afterUpdate", e)
                        }
                        )))
                }
            }, {
                ...
                value: function (e) {
                    ...
                    return "auto" === c && (c = Math.abs(n / i - r / a) > .1),
                    {
                        top: s,
                        left: l,
                        scale: r && n ? n / r : 1,
                ...
                value: function (e) {
                    ...
                    if (window.visualViewport && 1 !== window.visualViewport.scale)
                        return !1;
                    if (e.Panzoom && !e.Panzoom.content.width)
                        return !1;
                    if (!t.option("Image.zoom") || "contain" !== t.option("Image.fit"))
                        return !1;
                    var i = e.$thumb;
                    if (!i || "loading" === e.state)
                        return !1;
                    n.classList.add("fancybox__no-click");
                    var o, r = i.getBoundingClientRect();
                    if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
                        var a = document.elementFromPoint(r.left + 1, r.top + 1) === i
                            , s = document.elementFromPoint(r.right - 1, r.bottom - 1) === i;
                        o = a && s
                    } else
                        o = document.elementFromPoint(r.left + .5 * r.width, r.top + .5 * r.height) === i;
                    return n.classList.remove("fancybox__no-click"),
                        o
                }
            }, {
                key: "zoomIn",
                value: function () {
                    ...
                    e.trigger("reveal", t),
                        ...
                        t.state = "zoomIn",
                        !0 === s && n.on("afterTransform", (function (e) {
                ...
                value: function (e) {
                    if ("image" === e.type && e.$el) {
                        ...
                        o.remove(a),
                            o.remove(r),
                            t && "toggleZoom" === n ? t && 1 === t.content.scale && t.option("maxScale") - t.content.scale > .01 ? o.add(r) : t.content.scale > 1 && !i && o.add(a) : "close" === n && o.add(a)
                    }
                }
            }, {
                key: "onWheel",
                ...
                value: function (e, t) {
                    ...
                    if ("ready" === this.fancybox.state) {
                        ...
                        if (!i || !i.dragPosition.midPoint && 0 === i.dragOffset.x && 0 === i.dragOffset.y && 1 === i.dragOffset.scale) {
                            ...
                            a ? this.clickTimer ? (clearTimeout(this.clickTimer),
                                this.clickTimer = null,
                                o(a)) : this.clickTimer = setTimeout((function () {
                                    n.clickTimer = null,
                                        o(r)
                                }
                                ), 300) : o(r)
            ...
            return a(e, [{
                ...
                value: function (e) {
                    ...
                    if (o.slug)
                        ...
                        var s = o.$trigger && o.$trigger.dataset
                            , l = e.option("slug") || s && s.fancybox;
                        l && l.length && "true" !== l && (a = "#" + l + (n.slides.length > 1 ? "-" + (o.index + 1) : ""))
                    }
                    i && (this.origHash = r !== a ? r : ""),
                        a && r !== a && (this.timer = setTimeout((function () {
                            try {
                                window.history[i ? "pushState" : "replaceState"]({}, document.title, window.location.pathname + window.location.search + a),
                    ...
                    if (t && !t.getInstance() && !1 !== t.defaults.Hash) {
                        ...
                        if (o) {
                            ...
                            if (a && a.dispatchEvent(new CustomEvent("click", {
                                ...
                                !t.getInstance()) {
                                var s = document.querySelectorAll('[data-fancybox="'.concat(o, '"]'));
                                s.length && (null === r && 1 === s.length ? a = s[0] : r && (a = s[r - 1]),
                ...
                value: function () {
                    ...
                    if (r && r.plugins.Hash) {
                        if (n) {
                            var a = r.Carousel;
                            if (n === r.option("slug"))
                                return a.slideTo(i - 1);
                            var s, l = x(a.slides);
                            try {
                                for (l.s(); !(s = l.n()).done;) {
                                    var c = s.value;
                                    if (c.slug && c.slug === n)
                                        return a.slideTo(c.index)
                                }
                            } catch (e) {
                                l.e(e)
                            } finally {
                            ...
                            var u = r.getSlide()
                                , h = u.$trigger && u.$trigger.dataset;
                            if (h && h.fancybox === n)
                                return a.slideTo(i - 1)
                        }
                        r.plugins.Hash.hasSilentClose = !0,
                            r.close()
                    }
                    e.startFromUrl()
                }
                    ...
                    value: function () {
                        ...
                        if (this.active && !this.timer) {
                            ...
                            this.timer = setTimeout((function () {
                                e.timer = null,
                                    e.fancybox.option("infinite") || e.fancybox.getSlide().index !== e.fancybox.Carousel.slides.length - 1 ? e.fancybox.next() : e.fancybox.jumpTo(0, {
                                        friction: 0
                                    })
                            }
                            ), t);
                            var n = this.$progress;
                            n || ((n = document.createElement("div")).classList.add("fancybox__progress"),
                                this.fancybox.$carousel.parentNode.insertBefore(n, this.fancybox.$carousel),
                                this.$progress = n,
                                n.offsetHeight),
            ...
            , ne = function () {
                function e(t) {
                    ...
                    o(this, e),
                        ...
                        this.$container = null,
                        this.state = "init";
                    for (var i = 0, r = ["onInit", "onPrepare", "onDone", "onKeydown", "onClosing", "onChange", "onSettle", "onRefresh"]; i < r.length; i++) {
                        var a = r[i];
                ...
                return a(e, [{
                    ...
                    value: function () {
                        if (this.fancybox.option("Toolbar.autoEnable")) {
                            var e, t = !1, n = x(this.fancybox.items);
                            try {
                                for (n.s(); !(e = n.n()).done;)
                        ...
                        var i, o = x(this.fancybox.option("Toolbar.display"));
                        try {
                            for (o.s(); !(i = o.n()).done;) {
                                var r = i.value;
                                if ("close" === (w(r) ? r.id : r)) {
                    ...
                    value: function () {
                        ...
                        if ("init" === this.state && (this.build(),
                            ...
                            !e.Carousel.prevPage && (e.option("slideshow.autoStart") && this.Slideshow.activate(),
                    ...
                    value: function (e, t) {
                        ...
                        t.index === e.getSlide().index && (this.update(),
                            n && n.isActive() && (e.option("infinite") || t.index !== e.Carousel.slides.length - 1 ? n.setTimer() : n.deactivate()))
                    }
                }, {
                    key: "onRefresh",
                    value: function (e) {
                        e && e.index !== this.fancybox.getSlide().index || (this.update(),
                            !this.Slideshow || !this.Slideshow.isActive() || e && "done" !== e.state || this.Slideshow.deactivate())
                    }
                }, {
                    key: "onKeydown",
                    value: function (e, t, n) {
                        " " === t && this.Slideshow && (this.Slideshow.toggle(),
                            n.preventDefault())
                    }
                }, {
                    key: "onClosing",
                    ...
                    value: function (e) {
                        var t, n;
                        for (var i in "div" === e.type ? t = document.createElement("div") : (t = document.createElement("link" === e.type ? "a" : "button")).classList.add("carousel__button"),
                            t.innerHTML = e.html,
                            t.setAttribute("tabindex", e.tabindex || 0),
                            e.class && (n = t.classList).add.apply(n, m(e.class.split(" "))),
                            e.attr)
                    ...
                    value: function () {
                        var e = this;
                        this.cleanup();
                        var t, n = this.fancybox.option("Toolbar.items"), i = [{
                            position: "left",
                            items: []
                        }, {
                            position: "center",
                            ...
                            position: "right",
                            items: []
                        }], o = this.fancybox.plugins.Thumbs, r = x(this.fancybox.option("Toolbar.display"));
                        try {
                            var a = function () {
                                var r = t.value
                                    , a = void 0
                                ...
                                if (w(r) ? (a = r.id,
                                    s = k({}, n[a], r)) : s = n[a = r],
                                    ["counter", "next", "prev", "slideshow"].includes(a) && e.fancybox.items.length < 2)
                                    return "continue";
                                if ("fullscreen" === a) {
                                ...
                                if ("thumbs" === a && (!o || "disabled" === o.state))
                                    return "continue";
                                if (!s)
                                    return "continue";
                                var l = s.position || "right"
                                    , c = i.find((function (e) {
                                        return e.position === l
                                    }
                                    ));
                        ...
                        for (var l = 0, c = i; l < c.length; l++) {
                            ...
                            if (u.items.length) {
                                ...
                                h.classList.add("fancybox__toolbar__items"),
                                    h.classList.add("fancybox__toolbar__items--".concat(u.position));
                                var d, f = x(u.items);
                                try {
                                    for (f.s(); !(d = f.n()).done;) {
                                        var p = d.value;
                                        h.appendChild(this.createElement(p))
                                    }
                                } catch (e) {
                                    f.e(e)
                                } finally {
                    ...
                    key: "update",
                    value: function () {
                        var e, t = this.fancybox.getSlide(), n = t.index, i = this.fancybox.items.length, o = t.downloadSrc || ("image" !== t.type || t.error ? null : t.src), r = x(this.fancybox.$container.querySelectorAll("a.fancybox__button--download"));
                        try {
                            for (r.s(); !(e = r.n()).done;) {
                                var a = e.value;
                                o ? (a.removeAttribute("disabled"),
                                    ...
                                    a.setAttribute("download", o),
                                    a.setAttribute("target", "_blank")) : (a.setAttribute("disabled", ""),
                        ...
                        var s, l = t.Panzoom, c = l && l.option("maxScale") > l.option("baseScale"), u = x(this.fancybox.$container.querySelectorAll(".fancybox__button--zoom"));
                        try {
                            for (u.s(); !(s = u.n()).done;) {
                                var h = s.value;
                        ...
                        var d, f = x(this.fancybox.$container.querySelectorAll("[data-fancybox-index]"));
                        try {
                            for (f.s(); !(d = f.n()).done;)
                                d.value.innerHTML = t.index + 1
                        } catch (e) {
                            f.e(e)
                        } finally {
                            f.f()
                        }
                        var p, v = x(this.fancybox.$container.querySelectorAll("[data-fancybox-count]"));
                        try {
                            for (v.s(); !(p = v.n()).done;)
                                p.value.innerHTML = i
                        } catch (e) {
        ...
        var ie = {
            ...
            , se = function (e) {
                ...
                function n(e) {
                    ...
                    return o(this, n),
                        e = e.map((function (e) {
                            return e.width && (e._width = e.width),
                                e.height && (e._height = e.height),
                                e
                        }
                        )),
                        (i = t.call(this, k(!0, {}, oe, r))).bindHandlers(),
                        i.state = "init",
                        i.setItems(e),
                ...
                return a(n, [{
                    key: "option",
                    value: function (e) {
                        for (var t, i = this.getSlide(), o = i ? i[e] : void 0, r = arguments.length, a = new Array(r > 1 ? r - 1 : 0), s = 1; s < r; s++)
                            a[s - 1] = arguments[s];
                        var l;
                        return void 0 !== o ? ("function" == typeof o && (o = (l = o).call.apply(l, [this, this].concat(a))),
                            o) : (t = v(c(n.prototype), "option", this)).call.apply(t, [this, e].concat(a))
                    }
                }, {
                    key: "bindHandlers",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        t && (this.$root.insertAdjacentHTML("beforeend", this.localize(t)),
                            this.$container = this.$root.querySelector(".fancybox__container")),
                            this.$container || (this.$container = document.createElement("div"),
                                this.$root.appendChild(this.$container)),
                            this.$container.onscroll = function () {
                                return e.$container.scrollLeft = 0,
                                    !1
                            }
                            ,
                            Object.entries({
                                ...
                                var n;
                                return (n = e.$container).setAttribute.apply(n, m(t))
                            }
                            )),
                            ...
                            this.id || (this.id = this.options.id || ++ae,
                                this.$container.setAttribute("id", "fancybox-" + this.id));
                        var n, i = this.option("mainClass");
                        return i && (n = this.$container.classList).add.apply(n, m(i.split(" "))),
                    ...
                    value: function (e) {
                        ...
                        try {
                            for (i.s(); !(t = i.n()).done;) {
                                ...
                                if (r) {
                                    var a = r.dataset || {};
                                    o.src = a.src || r.getAttribute("href") || o.src,
                                        o.type = a.type || o.type,
                                        !o.src && r instanceof HTMLImageElement && (o.src = r.currentSrc || o.$trigger.src)
                                }
                                var s = o.$thumb;
                                if (!s) {
                                    var l = o.$trigger && o.$trigger.origTarget;
                                    l && (s = l instanceof HTMLImageElement ? l : l.querySelector("img:not([aria-hidden])")),
                                        !s && o.$trigger && (s = o.$trigger instanceof HTMLImageElement ? o.$trigger : o.$trigger.querySelector("img:not([aria-hidden])"))
                                }
                                o.$thumb = s || null;
                                var c = o.thumb;
                                !c && s && !(c = s.currentSrc || s.src) && s.dataset && (c = s.dataset.lazySrc || s.dataset.src),
                        ...
                        return this.Carousel = new H(this.$carousel, k(!0, {}, {
                            ...
                            Panzoom: {
                                ...
                                lockAxis: function () {
                                    if (e.Carousel) {
                                        var t = "x";
                                        return e.option("dragToClose") && (t += "y"),
                                            t
                                    }
                                }
                            },
                    ...
                    value: function (e, t) {
                        var n = t.caption || "";
                        if ("function" == typeof this.options.caption && (n = this.options.caption.call(this, this, this.Carousel, t)),
                    ...
                    value: function (e) {
                        ...
                        Math.abs(t) >= 150 || Math.abs(t) >= 35 && e.dragOffset.time < 350 ? (this.option("hideClass") && (this.getSlide().hideClass = "fancybox-throwOut".concat(e.content.y < 0 ? "Up" : "Down")),
                            this.close()) : "y" === e.lockAxis && e.panTo({
                                y: 0
                            })
                    }
                }, {
                    ...
                    value: function (e) {
                        if (this.isTopmost()) {
                            ...
                            if (n && !e.ctrlKey && !e.altKey && !e.shiftKey) {
                                ...
                                if ("Escape" !== t && !r && (e.target.isContentEditable || -1 !== ["BUTTON", "TEXTAREA", "OPTION", "INPUT", "SELECT", "VIDEO"].indexOf(i.nodeName)))
                                    return;
                    ...
                    value: function (e) {
                        if (!(n.ignoreFocusChange || ["init", "closing", "customClosing", "destroy"].indexOf(this.state) > -1)) {
                            ...
                            if (!o || !o.contains(document.activeElement)) {
                                ...
                                for (var r, a = [], s = 0, l = Array.from(t.querySelectorAll(B)); s < l.length; s++) {
                                    var c = l[s]
                                        , u = c.offsetParent
                                        , h = o && o.contains(c)
                                        , d = !this.Carousel.$viewport.contains(c);
                                    u && (h || d) ? (a.push(c),
                                        void 0 !== c.dataset.origTabindex && (c.tabIndex = c.dataset.origTabindex,
                                            c.removeAttribute("data-orig-tabindex")),
                                        (c.hasAttribute("autoFocus") || !r && h && !c.classList.contains("carousel__button")) && (r = c)) : (c.dataset.origTabindex = void 0 === c.dataset.origTabindex ? c.getAttribute("tabindex") : c.dataset.origTabindex,
                                            c.tabIndex = -1)
                                }
                                e ? a.indexOf(e.target) > -1 ? this.lastFocus = e.target : this.lastFocus === t ? X(a[a.length - 1]) : X(t) : this.option("autoFocus") && r ? X(r) : a.indexOf(document.activeElement) < 0 && X(t),
                    ...
                    value: function () {
                        if (q) {
                            ...
                            n || e > 0 && ((n = document.createElement("style")).id = t,
                                n.type = "text/css",
                    ...
                    key: "setContent",
                    value: function (e, t) {
                        var n, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, o = e.$el;
                        if (t instanceof HTMLElement)
                            ["img", "iframe", "video", "audio"].indexOf(t.nodeName.toLowerCase()) > -1 ? (n = document.createElement("div")).appendChild(t) : n = t;
                        else {
                            var r = document.createRange().createContextualFragment(t);
                            (n = document.createElement("div")).appendChild(r)
                        }
                        if (e.filter && !e.error && (n = n.querySelector(e.filter)),
                            n instanceof Element)
                            return e._className = "has-".concat(i.suffix || e.type || "unknown"),
                    ...
                    value: function (e) {
                        ...
                        if (n && ("top" !== n || !this.$closeButton)) {
                            ...
                            i.classList.add("carousel__button", "is-close"),
                                ...
                                "inside" === n ? (e.$closeButton && e.$closeButton.remove(),
                                    e.$closeButton = e.$content.appendChild(i)) : this.$closeButton = this.$container.insertBefore(i, this.$container.firstChild)
                        }
                    }
                }, {
                    key: "revealContent",
                    value: function (e) {
                        var t = this;
                        this.trigger("reveal", e),
                            e.$content.style.visibility = "";
                        var n = !1;
                        e.error || "loading" === e.state || null !== this.Carousel.prevPage || e.index !== this.options.startIndex || (n = void 0 === e.showClass ? this.option("showClass") : e.showClass),
                            n ? (e.state = "animating",
                    ...
                    value: function (e, t, n) {
                        e && e.dispatchEvent(new CustomEvent("animationend", {
                            ...
                            e && t ? (e.addEventListener("animationend", (function i(o) {
                                o.currentTarget === this && (e.removeEventListener("animationend", i),
                                    n && n(),
                    ...
                    value: function (e) {
                        var t = this;
                        e.state = "loading",
                            e.$el.classList.add("is-loading");
                        var n = e.$el.querySelector(".fancybox__spinner");
                        n || ((n = document.createElement("div")).classList.add("fancybox__spinner"),
                    ...
                    value: function (e) {
                        ...
                        t && (t.remove(),
                            ...
                            "loading" === e.state && (this.trigger("load", e),
                                e.state = "ready")
                    }
                }, {
                    key: "next",
                    ...
                    key: "isTopmost",
                    value: function () {
                        return n.getInstance().id == this.id
                    }
                }, {
                    key: "close",
                    value: function (e) {
                        ...
                        if (e && e.preventDefault(),
                            !this.isClosing() && !1 !== this.trigger("shouldClose", e) && (this.state = "closing",
                    ...
                    value: function () {
                        if ("destroy" !== this.state) {
                            ...
                            this.Carousel.destroy(),
                                ...
                                re.delete(this.id);
                            var t = n.getInstance();
                            t ? t.focus() : (document.documentElement.classList.remove("with-fancybox"),
                                document.body.classList.remove("is-using-mouse"),
                    ...
                    value: function (e) {
                        ...
                        if (!e.defaultPrevented && !(e.button && 0 !== e.button || e.ctrlKey || e.metaKey || e.shiftKey)) {
                            var i, o, r, a = e.composedPath()[0], s = a;
                            if ((s.matches("[data-fancybox-trigger]") || (s = s.closest("[data-fancybox-trigger]"))) && (t.triggerTarget = s,
                                i = s && s.dataset && s.dataset.fancyboxTrigger),
                                i) {
                                var l = document.querySelectorAll('[data-fancybox="'.concat(i, '"]'))
                                    , c = parseInt(s.dataset.fancyboxIndex, 10) || 0;
                                s = l.length ? l[c] : s
                            }
                            Array.from(n.openers.keys()).reverse().some((function (t) {
                                r = s || a;
                                var n = !1;
                                try {
                                    r instanceof Element && ("string" == typeof t || t instanceof String) && (n = r.matches(t) || (r = r.closest(t)))
                                } catch (e) { }
                    ...
                    value: function (e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
                            , i = function (e) {
                                for (var t = ["false", "0", "no", "null", "undefined"], n = ["true", "1", "yes"], i = Object.assign({}, e.dataset), o = {}, r = 0, a = Object.entries(i); r < a.length; r++) {
                                    var s = g(a[r], 2)
                                        , l = s[0]
                                        , c = s[1];
                                    if ("fancybox" !== l)
                                ...
                                return e instanceof Element && (o.$trigger = e),
                                    o
                            }
                            , o = []
                            , r = t.startIndex || 0
                            , a = t.target || null
                            , s = void 0 !== (t = k({}, t, n.openers.get(e))).groupAll && t.groupAll
                            , l = void 0 === t.groupAttr ? "data-fancybox" : t.groupAttr
                            , c = l && a ? a.getAttribute("".concat(l)) : "";
                        if (!a || c || s) {
                            var u = t.root || (a ? a.getRootNode() : document.body);
                            o = [].slice.call(u.querySelectorAll(e))
                        }
                        if (a && !s && (o = c ? o.filter((function (e) {
                            ...
                            return !1;
                        var h = n.getInstance();
                        return !(h && o.indexOf(h.options.$trigger) > -1) && (r = a ? o.indexOf(a) : r,
                            new n(o = o.map(i), k({}, t, {
                                startIndex: r,
                                $trigger: a
                            })))
                    ...
                    value: function (e) {
                        ...
                        q && (n.openers.size || (/complete|interactive|loaded/.test(document.readyState) ? i() : document.addEventListener("DOMContentLoaded", i)),
                            n.openers.set(e, t))
                    }
                }, {
                    key: "unbind",
                    value: function (e) {
                        n.openers.delete(e),
                            n.openers.size || n.destroy()
                    }
                }, {
                    key: "destroy",
                    value: function () {
                        for (var e; e = n.getInstance();)
                            e.destroy();
                        n.openers = new Map,
                    ...
                    key: "getInstance",
                    value: function (e) {
                        return e ? re.get(e) : Array.from(re.values()).reverse().find((function (e) {
        ...
        for (var le = 0, ce = Object.entries(se.Plugins || {}); le < ce.length; le++) {
            var ue = g(ce[le], 2);
            ue[0];
            var he = ue[1];
            "function" == typeof he.create && he.create(se)
        }
        e.Carousel = H,
            e.Fancybox = se,
            e.Panzoom = D
    ...
    function (e) {
        ...
        function o(t) {
            return i(t) || e.isPlainObject(t) ? t : {
                top: t,
                left: t
            }
        }
        return t.defaults = {
            ...
            e.fn.scrollTo = function (r, a, s) {
                ...
                return l && (a /= 2),
                    ...
                    this.each((function () {
                        if (null !== r) {
                            var c, u = n(this), h = u ? this.contentWindow || window : this, d = e(h), f = r, p = {};
                            switch (typeof f) {
                                case "number":
                                case "string":
                                    if (/^([+-]=?)?\d+(\.\d+)?(px|%)?$/.test(f)) {
                            ...
                            var v = i(s.offset) && s.offset(h, f) || s.offset;
                            e.each(s.axis.split(""), (function (e, n) {
                                ...
                                if (c)
                                    ...
                                    var y = f[o];
                                    p[r] = y.slice && "%" === y.slice(-1) ? parseFloat(y) / 100 * m : y
                                }
                                s.limit && /^\d+$/.test(p[r]) && (p[r] = p[r] <= 0 ? 0 : Math.min(p[r], m)),
                                    !e && s.axis.length > 1 && (a === p[r] ? p = {} : l && (g(s.onAfterFirst),
                                        p = {}))
                            }
                            )),
                                g(s.onAfter)
