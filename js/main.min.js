!function (global, factory) {
    "object" == typeof exports && "undefined" != typeof module ? factory(exports) : "function" == typeof define && define.amd ? define("main", ["exports"], factory) : factory((global = global || self).main = {})
    ...
    const globalJS = {
        autoFillNoImage: () => {
            setTimeout((() => {
                $("img").each((function () {
                    $(this).hasAttr("data-src") ? "" === $(this).attr("data-src") && ($(this).attr("data-src", "/no-image.png"),
                        $(this).attr("src", "/no-image.png"),
                        $(this).addClass("noImage")) : $(this).hasAttr("src") && "" === $(this).attr("src") && ($(this).attr("src", "/no-image.png"),
        ...
        ,
        setBackground: () => {
            jQuery.each(["", "top", "left", "right", "bottom"], (function (index, item) {
                $(`[setBackground${item}]`).each((function () {
                    var background = $(this).attr("setBackground" + item)
                        , bgMobile = $(this).attr("setBackgroundMobile")
                        , breakpoint = $(this).attr("breakpoint");
                    $(this).css({
                        ...
                        void 0 !== bgMobile && ww < breakpoint ? $(this).css({
        ...
        scrollToTop: () => {
            $(window).on("scroll", (function () {
                $(this).scrollTop() >= $("#main-banner").outerHeight() - $("header").outerHeight() || $(this).scrollTop() >= $("#page-banner").outerHeight() - $("header").outerHeight() ? $("#scrollToTop").addClass("active") : $("#scrollToTop").removeClass("active")
            }
            )),
        ...
        inputButtonSubmit: () => {
            $("input[type='submit']").each((function () {
                $(this).parent().is(".btn") && ($(this).parent().addClass("has-input-submit"),
        ...
        module.exports = function () {
                        ...
                        for (let e = 0; e < this.length; e += 1) {
                            ...
                            if (!i && s.dom7Listeners ? a = s.dom7Listeners[t] : i && s.dom7LiveListeners && (a = s.dom7LiveListeners[t]),
                                ...
                                for (let e = a.length - 1; e >= 0; e -= 1) {
                                    const i = a[e];
                                    n && i.listener === n || n && i.listener && i.listener.dom7proxy && i.listener.dom7proxy === n ? (s.removeEventListener(t, i.proxyListener, r),
                                        a.splice(e, 1)) : n || (s.removeEventListener(t, i.proxyListener, r),
                                            a.splice(e, 1))
                                }
                        }
                    }
            ...
            function h(e, t) {
                ...
                return s.WebKitCSSMatrix ? (i = l.transform || l.webkitTransform,
                    ...
                    r = new s.WebKitCSSMatrix("none" === i ? "" : i)) : (r = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform || l.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
                        a = r.toString().split(",")),
                ...
                for (let s = 1; s < arguments.length; s += 1) {
                    ...
                    if (null != a && !f(a)) {
                        ...
                        for (let t = 0, i = s.length; t < i; t += 1) {
                            ...
                            void 0 !== n && n.enumerable && (m(e[i]) && m(a[i]) ? a[i].__swiper__ ? e[i] = a[i] : g(e[i], a[i]) : !m(e[i]) && m(a[i]) ? (e[i] = {},
                ...
                return void 0 === e && (e = {}),
                    y || (y = function (e) {
                        ...
                        const u = r.match(/(iPod)(.*OS\s([\d_]+))?/)
                            ...
                            , m = "Win32" === i;
                        let f = "MacIntel" === i;
                        return !p && f && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${o}x${d}`) >= 0 && (p = r.match(/(Version)\/([\d.]+)/),
                            p || (p = [0, 1, "13_0_0"]),
                            f = !1),
                            c && !m && (l.os = "android",
                                l.android = !0),
            ...
            var E = {
                ...
                , $ = {
                    ...
                    updateSlides: function () {
                        ...
                        const a = e.params
                            , { $wrapperEl: i, size: n, rtlTranslate: r, wrongRTL: l } = e
                        ...
                        for (let i = 0; i < p; i += 1) {
                            E = 0;
                            const r = c.eq(i);
                            if (S && e.grid.updateSlide(i, r, p, t),
                                "none" !== r.css("display")) {
                                if ("auto" === a.slidesPerView) {
                                    ...
                                    E = (n - (a.slidesPerView - 1) * y) / a.slidesPerView,
                                        a.roundLengths && (E = Math.floor(E)),
                                        c[i] && (c[i].style[t("width")] = `${E}px`);
                                c[i] && (c[i].swiperSlideSize = E),
                                    m.push(E),
                                    a.centeredSlides ? (C = C + E / 2 + T / 2 + y,
                                        0 === T && 0 !== i && (C = C - n / 2 - y),
                                        0 === i && (C = C - n / 2 - y),
                                        Math.abs(C) < .001 && (C = 0),
                                        a.roundLengths && (C = Math.floor(C)),
                                        x % a.slidesPerGroup == 0 && u.push(C),
                                        h.push(C)) : (a.roundLengths && (C = Math.floor(C)),
                                            (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(C),
                                            h.push(C),
                                            C = C + E + y),
                                    e.virtualSize += E + y,
                                    T = E,
                        ...
                        if (e.virtualSize = Math.max(e.virtualSize, n) + g,
                            r && l && ("slide" === a.effect || "coverflow" === a.effect) && i.css({
                ...
                , M = {
                    ...
                    setTranslate: function (e, t) {
                        const s = this
                            , { rtlTranslate: a, params: i, $wrapperEl: n, wrapperEl: r, progress: l } = s;
                        let o, d = 0, c = 0;
            ...
            var k = {
                slideTo: function (e, t, s, a, i) {
                    ...
                    if (n.animating && l.preventInteractionOnTransition || !m && !a && !i)
                        return !1;
                    const f = Math.min(n.params.slidesPerGroupSkip, r);
                    let g = f + Math.floor((r - f) / n.params.slidesPerGroup);
                    g >= o.length && (g = o.length - 1),
                        (p || l.initialSlide || 0) === (c || 0) && s && n.emit("beforeSlideChangeStart");
                    const v = -o[g];
                    ...
                    if (n.initialized && r !== p) {
                        if (!n.allowSlideNext && v < n.translate && v < n.minTranslate())
                            return !1;
                        if (!n.allowSlidePrev && v > n.translate && v > n.maxTranslate() && (p || 0) !== r)
                            return !1
                    }
                    let w;
                ...
                slideNext: function (e, t, s) {
                    void 0 === e && (e = this.params.speed),
                        void 0 === t && (t = !0);
                    const a = this
                        , { animating: i, enabled: n, params: r } = a;
                    if (!n)
                        return a;
                ...
                slidePrev: function (e, t, s) {
                    void 0 === e && (e = this.params.speed),
                        void 0 === t && (t = !0);
                    const a = this
                        , { params: i, animating: n, snapGrid: r, slidesGrid: l, rtlTranslate: o, enabled: d } = a;
                    if (!d)
                        return a;
                    if (i.loop) {
                ...
                , L = {
                    ...
                    loopFix: function () {
                        ...
                        const { activeIndex: t, slides: s, loopedSlides: a, allowSlidePrev: i, allowSlideNext: n, snapGrid: r, rtlTranslate: l } = e;
                        let o;
                        e.allowSlidePrev = !0,
                            e.allowSlideNext = !0;
                        const d = -r[t] - e.getTranslate();
                        t < a ? (o = s.length - 3 * a + t,
                            o += a,
                            e.slideTo(o, 0, !1, !0) && 0 !== d && e.setTranslate((l ? -e.translate : e.translate) - d)) : t >= s.length - a && (o = -s.length + t + a,
                                o += a,
            ...
            function z(e) {
                ...
                if (void 0 === i.isScrolling) {
                    let e;
                    s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : f * f + g * g >= 25 && (e = 180 * Math.atan2(Math.abs(g), Math.abs(f)) / Math.PI,
                ...
                if (n.touchReleaseOnEdges && (w = 0),
                    v > 0 && i.currentTranslate > s.minTranslate() ? (b = !1,
                        n.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** w)) : v < 0 && i.currentTranslate < s.maxTranslate() && (b = !1,
                            n.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** w)),
            ...
            function I(e) {
                const t = this
                    , s = t.touchEventsData
                    , { params: a, touches: i, rtlTranslate: n, slidesGrid: r, enabled: l } = t;
                if (!l)
                    return;
                let o = e;
                ...
                for (let e = 0; e < r.length; e += e < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
                    ...
                    void 0 !== r[e + t] ? h >= r[e] && h < r[e + t] && (m = e,
                        f = r[e + t] - r[e]) : h >= r[e] && (m = e,
                ...
                if (c > a.longSwipesMs) {
                    ...
                    "next" === t.swipeDirection && (b >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? g : m + w) : t.slideTo(m)),
                        "prev" === t.swipeDirection && (b > 1 - a.longSwipesRatio ? t.slideTo(m + w) : null !== v && b < 0 && Math.abs(b) > a.longSwipesRatio ? t.slideTo(v) : t.slideTo(m))
                } else {
                    if (!a.shortSwipes)
                        return void t.slideTo(t.activeIndex);
                    !t.navigation || o.target !== t.navigation.nextEl && o.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + w),
                        "prev" === t.swipeDirection && t.slideTo(null !== v ? v : m)) : o.target === t.navigation.nextEl ? t.slideTo(m + w) : t.slideTo(m)
                }
            }
            function A() {
                const e = this
            ...
            var _ = {
                attachEvents: function () {
                    ...
                    e.onTouchStart = O.bind(e),
                        ...
                        e.onClick = D.bind(e),
                        i.touch && !G && (t.addEventListener("touchstart", N),
                            G = !0),
                        H(e, "on")
                },
            ...
            var j = {
                addClasses: function () {
                    const e = this
                        , { classNames: t, params: s, rtl: a, $el: i, device: n, support: r } = e
                        , l = function (e, t) {
                            const s = [];
                            return e.forEach((e => {
                ...
                breakpoints: {
                    setBreakpoint: function () {
                        ...
                        const o = (l in r ? r[l] : void 0) || e.originalParams
                            ...
                            , c = V(e, o)
                            , p = i.enabled;
                        d && !c ? (n.removeClass(`${i.containerModifierClass}grid ${i.containerModifierClass}grid-column`),
                            e.emitContainerClasses()) : !d && c && (n.addClass(`${i.containerModifierClass}grid`),
                                (o.grid.fill && "column" === o.grid.fill || !o.grid.fill && "column" === i.grid.fill) && n.addClass(`${i.containerModifierClass}grid-column`),
                                e.emitContainerClasses()),
            ...
            class X {
                ...
                slidesPerViewDynamic(e, t) {
                    void 0 === e && (e = "current"),
                        void 0 === t && (t = !1);
                    const { params: s, slides: a, slidesGrid: i, slidesSizesGrid: n, size: r, activeIndex: l } = this;
                    let o = 1;
                    if (s.centeredSlides) {
                        ...
                        t.params.resizeObserver && void 0 !== i.ResizeObserver ? t && !t.destroyed && t.initialized && (r = new ResizeObserver((e => {
                            l = i.requestAnimationFrame((() => {
                                ...
                                let i = s
                                    , n = a;
                                e.forEach((e => {
                                    let { contentBoxSize: s, contentRect: a, target: r } = e;
                                    r && r !== t.el || (i = a ? a.width : (s[0] || s).inlineSize,
                            ...
                            r.observe(t.el)) : (i.addEventListener("resize", o),
            ...
            const J = [function (e) {
                ...
                , function (e) {
                    ...
                    function p() {
                        ...
                        if (t.params.loop ? (p = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup),
                            ...
                            let i, o, u;
                            if (s.dynamicBullets && (r = a.eq(0)[t.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                        ...
                        if ("fraction" === s.type && (n.find(U(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
                            n.find(U(s.totalClass)).text(s.formatFractionTotal(u))),
                            "progressbar" === s.type) {
                            let e;
                            ...
                            let i = 1
                                , r = 1;
                            "horizontal" === e ? i = a : r = a,
                                n.find(U(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${i}) scaleY(${r})`).transition(t.params.speed)
                        }
                        "custom" === s.type && s.renderCustom ? (n.html(s.renderCustom(t, p + 1, u)),
                            i("paginationRender", n[0])) : i("paginationUpdate", n[0]),
                ...
                , function (e) {
                    ...
                    function w(e) {
                        const { scrollbar: s, rtlTranslate: a } = t
                            , { $el: i } = s;
                        let n;
                        n = (b(e) - i.offset()[t.isHorizontal() ? "left" : "top"] - (null !== l ? l : o / 2)) / (c - o),
                    ...
                    function y(e) {
                        const s = t.params.scrollbar
                            ...
                            , { $el: r, $dragEl: o } = a;
                        h = !0,
                            l = e.target === o[0] || e.target === o ? b(e) - e.target.getBoundingClientRect()[t.isHorizontal() ? "left" : "top"] : null,
                            e.preventDefault(),
                            e.stopPropagation(),
                            i.transition(100),
                            o.transition(100),
                    ...
                    function x(e) {
                        const { scrollbar: s, touchEventsTouch: a, touchEventsDesktop: i, params: n, support: l } = t
                            , o = s.$el;
                        if (!o)
                            return;
                        const d = o[0]
                        ...
                        l.touch ? (d[u](a.start, y, c),
                            d[u](a.move, C, c),
                            d[u](a.end, T, p)) : (d[u](i.start, y, c),
                                r[u](i.move, C, c),
                                r[u](i.end, T, p))
                    }
                    function S() {
                        ...
                        0 === n.length && (n = d(`<div class="${t.params.scrollbar.dragClass}"></div>`),
                            i.append(n)),
                            Object.assign(e, {
                                $el: i,
                                el: i[0],
                    ...
                    s({
                        ...
                        i("init", (() => {
                            !1 === t.params.scrollbar.enabled ? $() : (S(),
                                v(),
                                g())
                        }
                        )),
                            ...
                            setTranslate: function (e, s) {
                                ...
                                function o(e) {
                                    ...
                                    "slide" === t.params.controller.by && (function (e) {
                                        ...
                                        r && "container" !== t.params.controller.by || (n = (e.maxTranslate() - e.minTranslate()) / (t.maxTranslate() - t.minTranslate()),
                            ...
                            setTransition: function (e, s) {
                                ...
                                if (Array.isArray(i))
                                    for (n = 0; n < i.length; n += 1)
                                        i[n] !== s && i[n] instanceof a && r(i[n]);
                                else
                                    i instanceof a && s !== i && r(i)
                            }
                        })
                }
                , function (e) {
                        ...
                        Object.assign(t, {
                            freeMode: {
                                ...
                                onTouchEnd: function (e) {
                                    let { currentPos: s } = e;
                                    const { params: n, $wrapperEl: r, rtlTranslate: l, snapGrid: o, touchEventsData: d } = t
                                    ...
                                    if (s < -t.minTranslate())
                                        ...
                                        if (n.freeMode.momentum) {
                                            ...
                                            let f;
                                            if (c < t.maxTranslate())
                                                n.freeMode.momentumBounce ? (c + t.maxTranslate() < -m && (c = t.maxTranslate() - m),
                                                    p = t.maxTranslate(),
                                                    h = !0,
                                                    d.allowMomentumBounce = !0) : c = t.maxTranslate(),
                                                    n.loop && n.centeredSlides && (f = !0);
                                            else if (c > t.minTranslate())
                                                n.freeMode.momentumBounce ? (c - t.minTranslate() > m && (c = t.minTranslate() + m),
                                                    p = t.minTranslate(),
                                                    h = !0,
                    ...
                    n({
                        ...
                        i.grid = {
                            ...
                            updateWrapperSize: (e, s, a) => {
                                const { spaceBetween: n, centeredSlides: r, roundLengths: l } = i.params
                                    , { rows: o } = i.params.grid;
                                if (i.virtualSize = (e + n) * t,
                                    i.virtualSize = Math.ceil(i.virtualSize / o) - n,
                                    i.$wrapperEl.css({
                ...
                , function (e) {
                    ...
                    !function (e) {
                        const { effect: t, swiper: s, on: a, setTranslate: i, setTransition: n, overwriteParams: r, perspective: l, recreateShadows: o, getEffectParams: d } = e;
                        let c;
                        a("beforeInit", (() => {
                        ...
                        setTranslate: () => {
                            ...
                            for (let s = 0; s < e.length; s += 1) {
                                ...
                                if (m && f.shadow || !m) {
                                    ...
                                    if (0 === e.length && f.shadow && (e = K(n, a)),
                                        e.length) {
                            ...
                            (s ? t.slides.find(s) : t.slides).transition(e).find(".swiper-slide-shadow").transition(e),
                                function (e) {
                                    ...
                                    if (t.params.virtualTranslate && 0 !== s) {
                                        let e, s = !1;
                                        e = i ? a ? n.find(a) : n : a ? n.eq(r).find(a) : n.eq(r),
                                            e.transitionEnd((() => {
                                                if (s)
                                                    return;
                                                if (!t || t.destroyed)
    ...
    function swiperInit() {
        ...
        new swiper("#main-banner .swiper", {
            ...
            ww < 1024 && $("#main-banner .arrow-button [class*='swiper-button']").on("click", (function () {
                console.log("sad"),
                    setTimeout((() => {
                        $("html,body").animate({
                            scrollTop: 0
        ...
        new swiper(".home-2 .swiper", {
            ...
            new swiper(".introduce-slide .swiper", {
                ...swiperParameter,
                navigation: {
        ...
        new swiper(".systemdetail-1 .main .swiper", {
            speed: 500,
            slidesPerView: 1,
            observer: !0,
            observeParents: !0,
                ...
                slideChange: function () {
                    !function autoSlideNextOnThumbSlide(initSwiper, element, thumb) {
                        let activeIndex = initSwiper.activeIndex + 1
                            , nextSlide = (document.querySelector(`${element} ${thumb} .swiper-slide:nth-child(${activeIndex})`),
                                document.querySelector(`${element} ${thumb} .swiper-slide:nth-child(${activeIndex + 1})`))
                            , prevSlide = document.querySelector(`${element} ${thumb} .swiper-slide:nth-child(${activeIndex - 1})`);
                        nextSlide && !nextSlide.classList.contains("swiper-slide-visible") ? initSwiper.thumbs.swiper.slideNext() : prevSlide && !prevSlide.classList.contains("swiper-slide-visible") && initSwiper.thumbs.swiper.slidePrev()
                    }(this, ".systemdetail-1", ".thumb")
                }
            }
        }),
            new swiper(".newsother .swiper", {
                ...swiperParameter,
                navigation: {
    ...
    var item = createCommonjsModule((function (module, exports) {
        ...
        var Item = function () {
            function Item(item) {
                var extractor = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function (i) {
                    return i
                }
                    ;
            ...
            return function _createClass(Constructor, protoProps, staticProps) {
                ...
                value: function from() {
                    var _this = this
                        , items = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : []
                        , extractor = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : function (i) {
                            return i
                        }
                        ;
    ...
    var subset = createCommonjsModule((function (module, exports) {
        Object.defineProperty(exports, "__esModule", {
            ...
            exports.default = void 0;
        var _item = function _interopRequireDefault(obj) {
    ...
    var chronological = createCommonjsModule((function (module, exports) {
        Object.defineProperty(exports, "__esModule", {
            ...
            exports.default = void 0;
        var _subset = function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                default: obj
            }
        }(subset);
        ...
        var Chronological = function () {
            ...
            return function _createClass(Constructor, protoProps, staticProps) {
                ...
                key: "partition",
                value: function partition(items, count) {
                    var subsets = _toConsumableArray(Array(count)).map((function (_) {
                        return new _subset.default
                    }
                    ));
                    return count > 0 && items.forEach((function (item, index) {
                ...
                value: function append(subsets, item) {
                    ...
                    var index = subsets.reduce((function (a, c) {
                        return a + c.count()
                    }
                    ), 0) % subsets.length;
                    return subsets[index].append(item),
                        index
                }
            }]),
                Chronological
            ...
            return function _createClass(Constructor, protoProps, staticProps) {
                ...
                value: function partition(items, count) {
                    var subsets = _toConsumableArray(Array(count)).map((function (_) {
                        ...
                        , sums = _toConsumableArray(Array(count)).map((function (_) {
                            return 0
                        }
                        ));
                    return count > 0 && (_toConsumableArray(items).sort((function (a, b) {
                ...
                value: function append(subsets, item) {
                    ...
                    return subsets[min].append(item),
                        min
                }
            }]),
                Greedy
    ...
    var set = createCommonjsModule((function (module, exports) {
        ...
        var _chronological = _interopRequireDefault(chronological)
            , _greedy = _interopRequireDefault(greedy)
            , _item = _interopRequireDefault(item);
        ...
        var Set = function () {
            ...
            return function _createClass(Constructor, protoProps, staticProps) {
                ...
                value: function partition(count) {
                    return this.subsets = this.algorithm.partition(this.items, count),
                        this.subsets
                }
            }, {
                key: "append",
                value: function append(item) {
                    ...
                    return this.items.push(wrapped),
                        this.algorithm.append(this.subsets, wrapped)
                }
            }]),
                Set
        }();
    ...
    var columns = createCommonjsModule((function (module, exports) {
        Object.defineProperty(exports, "__esModule", {
            ...
            exports.default = void 0;
        var _set = function _interopRequireDefault(obj) {
            return obj && obj.__esModule ? obj : {
                default: obj
            }
        }(set);
        ...
        var Columns = function () {
            ...
            return function _createClass(Constructor, protoProps, staticProps) {
                ...
                value: function count() {
                    ...
                    return Object.entries(this.options.breakpoints || {}).some((function (_ref) {
                ...
                value: function append(element) {
                    ...
                    return this.container.children[column].append(element),
                        this
                }
            }, {
                key: "render",
                value: function render() {
                    var _this$container, count = this.count(), columns = this._prepareColumns(count);
                    for (this.set.partition(count).forEach((function (c, i) {
                        var _columns$i;
                        return (_columns$i = columns[i]).append.apply(_columns$i, _toConsumableArray(c.lean()))
                    }
                    )),
                        this.container.dataset.columns = count; this.container.firstChild;)
                        this.container.removeChild(this.container.firstChild);
                    return (_this$container = this.container).append.apply(_this$container, _toConsumableArray(columns)),
                        this
                }
            }, {
                key: "setOptions",
                ...
                value: function _prepareColumns(count) {
                    var _this = this
                        , columns = [];
                    return _toConsumableArray(Array(count)).forEach((function () {
        ...
        , Columns = unwrapExports(columns)
        , aos = createCommonjsModule((function (module, exports) {
            module.exports = function (e) {
                ...
                , , , , , function (e, t) {
                    (function (t) {
                        ...
                        function a(e) {
                            return "symbol" == (void 0 === e ? "undefined" : c(e)) || r(e) && k.call(e) == d
                        }
                        function u(e) {
                            if ("number" == typeof e)
                                return e;
                ...
                , function (e, t) {
                    function n(e) {
                        ...
                        for (t = 0; t < e.length; t += 1) {
                            if ((o = e[t]).dataset && o.dataset.aos)
                                return !0;
                            if (o.children && n(o.children))
                                return !0
                        }
                        return !1
                    }
        ...
        , AOS = unwrapExports(aos);
    aos.AOS;
    $.fn.hasAttr = function (name) {
        return void 0 !== this.attr(name)
    }
        ;
    var ww = $(window).width()
        , body = $("body")
    ...
    var burger = header.find("#burger")
        ...
        , close_NB = (nav_mobile.find(".has-child"),
            nav_mobile.find(".close-nav-mobile"))
        , pagesBanner = $("#page-banner");
    $("#main-banner");
    ...
    const headerFunction = {
        onScroll: () => {
            $(window).on("scroll", (function () {
                $(this).scrollTop() > exports.height_header ? (header.addClass("header-scroll"),
                    $(".search-overlay").addClass("header-scroll")) : (header.removeClass("header-scroll"),
                        $(".search-overlay").removeClass("header-scroll")),
                    exports.height_header = header.outerHeight(),
                    $("html").css({
                        "--header-height": header.outerHeight() + "px"
                    }),
                    0 == $(this).scrollTop() && setTimeout((() => {
                        exports.height_header = header.outerHeight(),
                            $("html").css({
                                "--header-height": header.outerHeight() + "px"
                            })
                ...
                $(window).scrollTop() > exports.height_header && setTimeout((() => {
        ...
        navMobileChild: () => {
            var li = nav_mobile.find("li")
                , liChild = nav_mobile.find("li.has-child");
            liChild.find("em").on("click", (function () {
                $(this).closest("li").is(".checkActive") ? ($(this).closest("li").removeClass("checkActive"),
                    $(this).closest("li").find(".child").slideUp()) : (liChild.removeClass("checkActive"),
                ...
                li.each((function () {
                    $(this).is(".active") && $(this).find(".child").show()
                }
                ))
        }
        ,
            ...
            $(".search-icon").on("click", (function () {
                ...
                $(".search-overlay input").keyup((function () {
                    $(".search-overlay .searchbox").addClass("fixed-title"),
                        "" == $(this).val() && $(".search-overlay .searchbox").removeClass("fixed-title")
                }
                )),
                setTimeout((() => {
                    $(window).on("keyup", (function (event) {
                        27 == event.keyCode && $(".search-overlay").removeClass("active")
                    }
                    ))
                }
                ), 500),
                $(".search-overlay .searchbox input[type='text']").keypress((function (n) {
                    13 == n.keyCode && ($(".searchbox button").trigger("click"),
                        console.log("click"))
                }
                ))
        }
        ...
        escBtn: () => {
            $(window).on("keyup", (function (event) {
                27 == event.keyCode && (nav_mobile.removeClass("active"),
    ...
    function expandItem() {
        ...
        hasLoadBtn.each((function () {
            var count, $this = $(this), expandBtn = $(this).find(".expand-btn"), list = $(this).find(".expand-item").length, countMobile = $(this).attr("item-count-mobile");
            count = Number(null != countMobile && 0 != countMobile && ww < 576 ? $(this).attr("item-count-mobile") : $(this).attr("item-count"));
            var expand = Number($(this).attr("item-expand"));
            !function init(initValue, thisFunction) {
                list >= initValue ? thisFunction.find(".expand-item").slice(0, initValue).slideDown({
                    complete: function () {
                        $(this).addClass("done-animated")
                    }
                }) : (thisFunction.find(".expand-item").slideDown(),
                    thisFunction.find(".expand-item").addClass("done-animated")),
                    (0 == list || list <= initValue) && expandBtn.hide()
            }(count, $this),
                    ...
                    e.preventDefault(),
                        function expandBtnInit(initCount, thisFunction) {
                            count = initCount + expand <= list ? initCount + expand : list,
                                ...
                                count == list && thisFunction.slideUp()
                        }(count, $(this))
                }
                ))
        }
    ...
    $(document).ready((function () {
        globalJS.init(),
            ...
            function activeCommonNav() {
                $(".newslist-nav").length && $(".newslist-nav nav").scrollTo("li.active", 0)
            }(),
            ...
            aosAnimation(),
            function columnJS() {
                document.getElementById("auto-column") && (autoColumn = new Columns(document.getElementById("auto-column"), {
                    columns: 1,
                    breakpoints: {
                        576: 2
                    }
            ...
            exports.height_header = header.outerHeight(),
                ...
                function screenImage() {
                    var touchItem = $("[has-touch-screen]")
                        , screen = ($(this).attr("screen-left"),
                            $(this).attr("screen-right"),
                            .5 * ($(window).width() - $("main .container").width()));
                    ww >= 1280 ? setTimeout((() => {
                        touchItem.each((function () {
                            $(this).hasAttr("screen-left") ? $(this).css("margin-left", -screen) : $(this).css("margin-right", -screen),
                        ...
                        touchItem.each((function () {
                            $(this).hasAttr("screen-left") ? $(this).css("margin-left", "unset") : $(this).css("margin-right", "unset"),
        ...
        document.onreadystatechange = () => {
            "complete" === document.readyState && pagesBanner.addClass("initial")
        }
        ,
        window.externalJS = {
            useVariables: function useVariables() {
                return {
...
function changeImage() {
    i++;
    if (i > 5) i = 0;
    banner.style.backgroundImage = "linear-gradient(90deg, #000000 0%, rgba(0, 0, 0, 0) 100%), url('./assets/image/banner/banner" + i + ".jpg')";
    banner.style.transition = " linear 1s";
}

var t = setInterval(changeImage, 3500);
